      ...
      Typed type_ a ->
        ...
        in case unwrapTcoExpr a, expectedGoType of
          ...
          LetRec lvl bindings body, _ ->
            ...
            in translateExprImpl_ helpersRef depth modNameStr recVars moduleArities bound tcoIdent loopCtx isTail inEffectBlock nextId newA
          _, _ ->
            let res = translateExprImpl__ helpersRef depth modNameStr recVars moduleArities bound tcoIdent loopCtx isTail inEffectBlock (Just type_) nextId a
            in case res.exprType of
              TypeStructPointer _ _ _ _ -> res
              _ -> 
                if expectedGoType == res.exprType then res
            ...
            Nothing ->
              let
                ...
                getVar (Local mbIdent lvl) = 
                  ...
                  in Just { mbMod: Nothing, name: resolvedName }
            ...
            GetProp prop ->
              case resObj.exprType of
                TypeRecord fields ->
                  ...
                  in { stmts: resObj.stmts, expr: GoStructAccess resObj.expr (sanitizeName prop), exprType: fieldGoType, nextId: resObj.nextId }
      ...
      Update obj props ->
        ...
        in
          case resObj.exprType of
            ...
            _ ->
              let boxedExprs = map (\p -> Tuple p.key (boxGoExpr p.expr p.goType)) accProps.exprs
              in { stmts: resObj.stmts <> accProps.stmts, expr: GoRecordUpdateDict (boxGoExpr resObj.expr resObj.exprType) boxedExprs, exprType: TypeValue, nextId: accProps.nextId }
