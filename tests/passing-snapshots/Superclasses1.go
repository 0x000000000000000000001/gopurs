...
func Get_Main_suNumber() gopurs_runtime.Value {
	once_Main_suNumber.Do(func() {
		cache_Main_suNumber = gopurs_runtime.Value{Type: 9, IntVal: 999349368, UnsafePtr: unsafe.Pointer((&Constructor_Main_Su{1, gopurs_runtime.Func(func(n_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Main_su() gopurs_runtime.Value {
	once_Main_su.Do(func() {
		cache_Main_su = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_su(gopurs_runtime.CoerceToStruct[Constructor_Main_Su](dict_0_box))
		})
	})
...
func Get_Main_clNumber() gopurs_runtime.Value {
	once_Main_clNumber.Do(func() {
		cache_Main_clNumber = gopurs_runtime.Value{Type: 9, IntVal: 2792887505, UnsafePtr: unsafe.Pointer((&Constructor_Main_Cl{1, gopurs_runtime.Func(func(_dollar___unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Value{Type: 9, IntVal: 999349368, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Main_Su](Get_Main_suNumber()))}
...
func Get_Main_cl() gopurs_runtime.Value {
	once_Main_cl.Do(func() {
		cache_Main_cl = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_cl(gopurs_runtime.CoerceToStruct[Constructor_Main_Cl](dict_0_box))
		})
	})
...
func Get_Main_test() gopurs_runtime.Value {
	once_Main_test.Do(func() {
		cache_Main_test = gopurs_runtime.Func(func(dictCl_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_test(gopurs_runtime.CoerceToStruct[Constructor_Main_Cl](dictCl_0_box))
		})
	})
...
func Get_Main_cl__826691443() gopurs_runtime.Value {
	once_Main_cl__826691443.Do(func() {
		cache_Main_cl__826691443 = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_cl__826691443(gopurs_runtime.CoerceToStruct[Constructor_Main_Cl](dict_0_box))
		})
	})
...
func Get_Main_su__2782801075() gopurs_runtime.Value {
	once_Main_su__2782801075.Do(func() {
		cache_Main_su__2782801075 = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_su__2782801075(gopurs_runtime.CoerceToStruct[Constructor_Main_Su](dict_0_box))
		})
	})
...
func Get_Main_test__2037638682() gopurs_runtime.Value {
	once_Main_test__2037638682.Do(func() {
		cache_Main_test__2037638682 = gopurs_runtime.Func(func(dictCl_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_test__2037638682(gopurs_runtime.CoerceToStruct[Constructor_Main_Cl](dictCl_0_box))
		})
	})
	return cache_Main_test__2037638682
}

type Constructor_Main_Su struct {
	Rc uint32
...
type Constructor_Main_Cl struct {
	Rc uint32
	V0 gopurs_runtime.Value
...
func Call_Main_su(dict_0_loop *Constructor_Main_Su) gopurs_runtime.Value {
	var dict_0 *Constructor_Main_Su = dict_0_loop
	_ = dict_0
	return gopurs_runtime.Box(dict_0.V0)
}

func Call_Main_cl(dict_0_loop *Constructor_Main_Cl) gopurs_runtime.Value {
	var dict_0 *Constructor_Main_Cl = dict_0_loop
	_ = dict_0
	return gopurs_runtime.Box(dict_0.V1)
}

func Call_Main_test(dictCl_0_loop *Constructor_Main_Cl) gopurs_runtime.Value {
	var dictCl_0 *Constructor_Main_Cl = dictCl_0_loop
	_ = dictCl_0
	// TAST (Let): Su0_1_0 shape=App(Other) expectedFromAst=*Constructor_Main_Su actual=*Constructor_Main_Su bindingType=(ADT ["Main","Su"] [(TypeVar a)])
	Su0_1_0 := gopurs_runtime.CoerceToStruct[Constructor_Main_Su](gopurs_runtime.Apply(gopurs_runtime.Box(dictCl_0.V0), gopurs_runtime.Value{}))
	_ = Su0_1_0
...
func Call_Main_cl__826691443(dict_0_loop *Constructor_Main_Cl) gopurs_runtime.Value {
	var dict_0 *Constructor_Main_Cl = dict_0_loop
	_ = dict_0
	return gopurs_runtime.Box(dict_0.V1)
}

func Call_Main_su__2782801075(dict_0_loop *Constructor_Main_Su) gopurs_runtime.Value {
	var dict_0 *Constructor_Main_Su = dict_0_loop
	_ = dict_0
	return gopurs_runtime.Box(dict_0.V0)
}

func Call_Main_test__2037638682(dictCl_0_loop *Constructor_Main_Cl) gopurs_runtime.Value {
	var dictCl_0 *Constructor_Main_Cl = dictCl_0_loop
	_ = dictCl_0
	// TAST (Let): Su0_1_0 shape=App(Other) expectedFromAst=*Constructor_Main_Su actual=*Constructor_Main_Su bindingType=(ADT ["Main","Su"] [Any])
	Su0_1_0 := gopurs_runtime.CoerceToStruct[Constructor_Main_Su](gopurs_runtime.Apply(gopurs_runtime.Box(dictCl_0.V0), gopurs_runtime.Value{}))
	_ = Su0_1_0
	return gopurs_runtime.Func(func(a_2 gopurs_runtime.Value) gopurs_runtime.Value {
		return gopurs_runtime.Apply(gopurs_runtime.Box(Su0_1_0.V0), gopurs_runtime.Apply2(gopurs_runtime.Box(dictCl_0.V1), a_2, a_2))
