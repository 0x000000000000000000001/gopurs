...
func Get_Main_test() gopurs_runtime.Value {
	once_Main_test.Do(func() {
		cache_Main_test = gopurs_runtime.Value{Type: 9, IntVal: int64(Call_Main_nubUnion(gopurs_runtime.Value{}, gopurs_runtime.Value{}, 513803634, 513803634)), UnsafePtr: nil}
	})
