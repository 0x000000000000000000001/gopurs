...
func Get_Main_test() gopurs_runtime.Value {
	once_Main_test.Do(func() {
		cache_Main_test = gopurs_runtime.Func3(func(dictEq_0_box gopurs_runtime.Value, f_1_box gopurs_runtime.Value, a_2_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_test(gopurs_runtime.CoerceToStruct[Constructor_Data_Eq_Eq](dictEq_0_box), f_1_box, a_2_box)
		})
	})
...
func Call_Main_test(dictEq_0_loop *Constructor_Data_Eq_Eq, f_1_loop gopurs_runtime.Value, a_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
	...
	return gopurs_runtime.Apply2(go__go_3_0_0, gopurs_runtime.Apply(f_1, a_2), a_2)
}
