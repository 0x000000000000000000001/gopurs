...
func Get_Main_lboxIdentity() gopurs_runtime.Value {
	once_Main_lboxIdentity.Do(func() {
		cache_Main_lboxIdentity = gopurs_runtime.Apply(Get_Main_unLBox(), gopurs_runtime.Func4(func(_dollar___unused_0 gopurs_runtime.Value, dictIsSymbol_1 gopurs_runtime.Value, lbl_2 gopurs_runtime.Value, f_3 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Apply3(f_3, gopurs_runtime.Value{}, gopurs_runtime.Value{Type: 9, IntVal: 2134024384, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Symbol_IsSymbol[gopurs_runtime.Value]](dictIsSymbol_1))}, gopurs_runtime.Value{Type: 9, IntVal: int64(uint32(lbl_2.IntVal)), UnsafePtr: nil})
		}))
	})
...
func Get_Main_get() gopurs_runtime.Value {
	once_Main_get.Do(func() {
		cache_Main_get = gopurs_runtime.Func4(func(dictIsSymbol_0_box gopurs_runtime.Value, _dollar___unused_1_box gopurs_runtime.Value, l_2_box gopurs_runtime.Value, r_3_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_get(gopurs_runtime.CoerceToStruct[Constructor_Data_Symbol_IsSymbol[gopurs_runtime.Value]](dictIsSymbol_0_box), _dollar___unused_1_box, uint32(l_2_box.IntVal), r_3_box)
		})
	})
...
func Get_Main_read() gopurs_runtime.Value {
	once_Main_read.Do(func() {
		cache_Main_read = gopurs_runtime.Func(func(rec_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_read(rec_0_box)
		})
	})
...
func Call_Main_get(dictIsSymbol_0_loop *Constructor_Data_Symbol_IsSymbol[gopurs_runtime.Value], _dollar___unused_1_loop gopurs_runtime.Value, l_2_loop uint32, r_3_loop gopurs_runtime.Value) gopurs_runtime.Value {
	...
	_ = r_3
	return gopurs_runtime.Apply2(Get_Record_Unsafe_unsafeGet(), gopurs_runtime.Str(gopurs_runtime.Apply(dictIsSymbol_0.V0, gopurs_runtime.Value{Type: 9, IntVal: int64(l_2), UnsafePtr: nil}).StrVal()), r_3)
}

func Call_Main_read(rec_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
	var rec_0 gopurs_runtime.Value = rec_0_loop
	_ = rec_0
	return gopurs_runtime.Apply(Get_Main_unLBox(), gopurs_runtime.Func3(func(_dollar___unused_1 gopurs_runtime.Value, dictIsSymbol_2 gopurs_runtime.Value, lbl_3 gopurs_runtime.Value) gopurs_runtime.Value {
		return gopurs_runtime.Apply2(Get_Record_Unsafe_unsafeGet(), gopurs_runtime.Str(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictIsSymbol_2, "reflectSymbol"), gopurs_runtime.Value{Type: 9, IntVal: int64(uint32(lbl_3.IntVal)), UnsafePtr: nil}).StrVal()), rec_0)
	}))
}
