...
func Get_Main_get() gopurs_runtime.Value {
	once_Main_get.Do(func() {
		cache_Main_get = gopurs_runtime.Func4(func(dictIsSymbol_0_box gopurs_runtime.Value, _dollar___unused_1_box gopurs_runtime.Value, l_2_box gopurs_runtime.Value, r_3_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_get(gopurs_runtime.CoerceToStruct[Constructor_Data_Symbol_IsSymbol[gopurs_runtime.Value]](dictIsSymbol_0_box), _dollar___unused_1_box, uint32(l_2_box.IntVal), func() *struct {
			} {
				orig := r_3_box
				_ = orig
				clone := struct {
...
func Get_Main_get__1573763043() gopurs_runtime.Value {
	once_Main_get__1573763043.Do(func() {
		cache_Main_get__1573763043 = gopurs_runtime.Func4(func(dictIsSymbol_0_box gopurs_runtime.Value, _dollar___unused_1_box gopurs_runtime.Value, l_2_box gopurs_runtime.Value, r_3_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_get__1573763043(gopurs_runtime.CoerceToStruct[Constructor_Data_Symbol_IsSymbol[gopurs_runtime.Value]](dictIsSymbol_0_box), _dollar___unused_1_box, uint32(l_2_box.IntVal), func() *struct {
			} {
				orig := r_3_box
				_ = orig
				clone := struct {
...
func Get_Main_read() gopurs_runtime.Value {
	once_Main_read.Do(func() {
		cache_Main_read = gopurs_runtime.Func2(func(rec_0_box gopurs_runtime.Value, v_1_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_read(func() *struct {
			} {
				orig := rec_0_box
				_ = orig
				clone := struct {
...
func Call_Main_unLBox(g_0_loop gopurs_runtime.Value, v_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
	...
	_ = v_1
	// TAST (Let): g2_2_0 shape=App(Other) bindingType=Any
		...
		return gopurs_runtime.Func(func(dictIsSymbol_2 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Func(func(lbl_3 gopurs_runtime.Value) gopurs_runtime.Value {
				return gopurs_runtime.Func(func(f_4 gopurs_runtime.Value) gopurs_runtime.Value {
					return gopurs_runtime.Apply3(f_4, gopurs_runtime.Value{}, gopurs_runtime.Value{Type: 9, IntVal: 2134024384, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Symbol_IsSymbol[gopurs_runtime.Value]](dictIsSymbol_2))}, gopurs_runtime.Value{Type: 9, IntVal: int64(uint32(lbl_3.IntVal)), UnsafePtr: nil})
				})
			})
		})
	}))
...
func Call_Main_get(dictIsSymbol_0_loop *Constructor_Data_Symbol_IsSymbol[gopurs_runtime.Value], _dollar___unused_1_loop gopurs_runtime.Value, l_2_loop uint32, r_3_loop *struct {
	...
	_ = r_3
	return gopurs_runtime.Apply2(Get_Record_Unsafe_unsafeGet(), gopurs_runtime.Str(gopurs_runtime.Apply(gopurs_runtime.Box(dictIsSymbol_0.V0), gopurs_runtime.Value{Type: 9, IntVal: int64(l_2), UnsafePtr: nil}).StrVal()), func() gopurs_runtime.Value {
		orig := r_3
		_ = orig
...
func Call_Main_get__1573763043(dictIsSymbol_0_loop *Constructor_Data_Symbol_IsSymbol[gopurs_runtime.Value], _dollar___unused_1_loop gopurs_runtime.Value, l_2_loop uint32, r_3_loop *struct {
}) gopurs_runtime.Value {
	var dictIsSymbol_0 *Constructor_Data_Symbol_IsSymbol[gopurs_runtime.Value] = dictIsSymbol_0_loop
	_ = dictIsSymbol_0
	var _dollar___unused_1 gopurs_runtime.Value = _dollar___unused_1_loop
...
func Call_Main_read(rec_0_loop *struct {
}, v_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
	var rec_0 *struct {
	} = rec_0_loop
	_ = rec_0
	var v_1 gopurs_runtime.Value = v_1_loop
	...
	return gopurs_runtime.Apply(v_1, gopurs_runtime.Func(func(_dollar___unused_2 gopurs_runtime.Value) gopurs_runtime.Value {
		return gopurs_runtime.Func(func(dictIsSymbol_3 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Func(func(lbl_4 gopurs_runtime.Value) gopurs_runtime.Value {
				return gopurs_runtime.Apply2(Get_Record_Unsafe_unsafeGet(), gopurs_runtime.Str(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictIsSymbol_3, "reflectSymbol"), gopurs_runtime.Value{Type: 9, IntVal: int64(uint32(lbl_4.IntVal)), UnsafePtr: nil}).StrVal()), func() gopurs_runtime.Value {
					orig := rec_0
					_ = orig
					return gopurs_runtime.RecordDict([]string{}, []gopurs_runtime.Value{})
				}())
