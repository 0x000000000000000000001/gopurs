	...
	once_Main_maybe.Do(func() {
		cache_Main_maybe = gopurs_runtime.RecordDict2("bind", "return", gopurs_runtime.Func(func(ma_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Func(func(f_1 gopurs_runtime.Value) gopurs_runtime.Value {
				...
				{
					if ma_0.Type == 9 && ma_0.IntVal == 3271839782 && ma_0.UnsafePtr != nil {
						__t0 = gopurs_runtime.CoerceToStruct[Constructor_Main_Just](gopurs_runtime.Apply(f_1, (*Constructor_Main_Just)(ma_0.UnsafePtr).V0))
						goto end_branch_0
					} else {
...
func Get_Main_test2() gopurs_runtime.Value {
	once_Main_test2.Do(func() {
		cache_Main_test2 = gopurs_runtime.Value{Type: 9, IntVal: 3271839782, UnsafePtr: unsafe.Pointer((&Constructor_Main_Just{1, gopurs_runtime.Float(1.0)}))}
	})
