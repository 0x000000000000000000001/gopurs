...
func Get_Main_main() gopurs_runtime.Value {
	once_Main_main.Do(func() {
		cache_Main_main = gopurs_runtime.Func(func(_ gopurs_runtime.Value) gopurs_runtime.Value {
			...
			go__go_2_5_2 = gopurs_runtime.Func(func(v_3_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
			...
			_dollar___unused_2_4 := gopurs_runtime.Apply(gopurs_runtime.Apply(Get_Effect_Console_log(), gopurs_runtime.Str(gopurs_runtime.Apply(Get_Data_Show_showIntImpl(), gopurs_runtime.Int(gopurs_runtime.Apply4(go__go_2_5_2, gopurs_runtime.Func(func(x_3 gopurs_runtime.Value) gopurs_runtime.Value {
				return x_3
			}), gopurs_runtime.Int(1), gopurs_runtime.Func(func(x_3 gopurs_runtime.Value) gopurs_runtime.Value {
				return gopurs_runtime.Int((x_3.IntVal) + (1))
			}), gopurs_runtime.Int(0)).IntVal)).StrVal())), gopurs_runtime.Value{})
			_ = _dollar___unused_2_4
			var go__go_3_8_3 gopurs_runtime.Value
			go__go_3_8_3 = gopurs_runtime.Func(func(v_4_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
				return gopurs_runtime.Func(func(v1_5_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
					return gopurs_runtime.Func(func(v2_6_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
						return func() gopurs_runtime.Value {
							...
							var v1_5_loop int64 = v1_5_loop_val.IntVal
							var v2_6_loop gopurs_runtime.Value = v2_6_loop_val
						go__go_3_8_3:
							for {
								if false {
									continue go__go_3_8_3
								}
			...
			_dollar___unused_3_7 := gopurs_runtime.Apply(gopurs_runtime.Apply(Get_Effect_Console_log(), gopurs_runtime.Str(gopurs_runtime.Apply(Get_Data_Show_showIntImpl(), gopurs_runtime.Int(gopurs_runtime.Apply4(go__go_3_8_3, gopurs_runtime.Func(func(x_4 gopurs_runtime.Value) gopurs_runtime.Value {
				return x_4
			}), gopurs_runtime.Int(2), gopurs_runtime.Func(func(x_4 gopurs_runtime.Value) gopurs_runtime.Value {
				return gopurs_runtime.Int((x_4.IntVal) + (1))
			}), gopurs_runtime.Int(0)).IntVal)).StrVal())), gopurs_runtime.Value{})
			_ = _dollar___unused_3_7
			var go__go_4_11_4 gopurs_runtime.Value
			go__go_4_11_4 = gopurs_runtime.Func(func(v_5_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
				return gopurs_runtime.Func(func(v1_6_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
					return gopurs_runtime.Func(func(v2_7_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
						return func() gopurs_runtime.Value {
							...
							var v1_6_loop int64 = v1_6_loop_val.IntVal
							var v2_7_loop gopurs_runtime.Value = v2_7_loop_val
						go__go_4_11_4:
							for {
								if false {
									continue go__go_4_11_4
								}
			...
			_dollar___unused_4_10 := gopurs_runtime.Apply(gopurs_runtime.Apply(Get_Effect_Console_log(), gopurs_runtime.Str(gopurs_runtime.Apply(Get_Data_Show_showIntImpl(), gopurs_runtime.Int(gopurs_runtime.Apply4(go__go_4_11_4, gopurs_runtime.Func(func(x_5 gopurs_runtime.Value) gopurs_runtime.Value {
				return x_5
			}), gopurs_runtime.Int(3), gopurs_runtime.Func(func(x_5 gopurs_runtime.Value) gopurs_runtime.Value {
				return gopurs_runtime.Int((x_5.IntVal) + (1))
			}), gopurs_runtime.Int(0)).IntVal)).StrVal())), gopurs_runtime.Value{})
			_ = _dollar___unused_4_10
			var go__go_5_14_5 gopurs_runtime.Value
			go__go_5_14_5 = gopurs_runtime.Func(func(v_6_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
				return gopurs_runtime.Func(func(v1_7_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
					return gopurs_runtime.Func(func(v2_8_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
						return func() gopurs_runtime.Value {
							...
							var v1_7_loop int64 = v1_7_loop_val.IntVal
							var v2_8_loop gopurs_runtime.Value = v2_8_loop_val
						go__go_5_14_5:
							for {
								if false {
									continue go__go_5_14_5
								}
			...
			_dollar___unused_5_13 := gopurs_runtime.Apply(gopurs_runtime.Apply(Get_Effect_Console_log(), gopurs_runtime.Str(gopurs_runtime.Apply(Get_Data_Show_showIntImpl(), gopurs_runtime.Int(gopurs_runtime.Apply4(go__go_5_14_5, gopurs_runtime.Func(func(x_6 gopurs_runtime.Value) gopurs_runtime.Value {
				return x_6
			}), gopurs_runtime.Int(4), gopurs_runtime.Func(func(x_6 gopurs_runtime.Value) gopurs_runtime.Value {
			...
			var go__go_7_18_6 gopurs_runtime.Value
			go__go_7_18_6 = gopurs_runtime.Func(func(v_8_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
				return func() gopurs_runtime.Value {
					var v_8_loop gopurs_runtime.Value = v_8_loop_val
				go__go_7_18_6:
					for {
						if false {
							continue go__go_7_18_6
						}
						...
						var __t20 gopurs_runtime.Value
						{
							if v_8.Type == 9 && v_8.IntVal == 525585346 {
								...
								{
									if ((*Constructor_Control_Monad_Rec_Class_Loop)(v_8.UnsafePtr).V0.IntVal) < (10000) {
										__t19 = gopurs_runtime.Value{Type: 9, IntVal: 525585346, UnsafePtr: unsafe.Pointer((&Constructor_Control_Monad_Rec_Class_Loop{1, gopurs_runtime.Int(((*Constructor_Control_Monad_Rec_Class_Loop)(v_8.UnsafePtr).V0.IntVal) + (1))}))}
										goto end_branch_19
									} else {
								...
								{
									__t19 = gopurs_runtime.Value{Type: 9, IntVal: 60402430, UnsafePtr: unsafe.Pointer((&Constructor_Control_Monad_Rec_Class_Done{1, gopurs_runtime.Int(42)}))}
								}
							end_branch_19:
								v_8_loop = __t19
								continue go__go_7_18_6
						...
						}
						{
							if v_8.Type == 9 && v_8.IntVal == 60402430 {
								__t20 = (*Constructor_Control_Monad_Rec_Class_Done)(v_8.UnsafePtr).V0
								goto end_branch_20
							} else {
			...
			_dollar___unused_7_17 := gopurs_runtime.Apply(gopurs_runtime.Apply(Get_Effect_Console_log(), gopurs_runtime.Str(gopurs_runtime.Apply(Get_Data_Show_showIntImpl(), gopurs_runtime.Int(gopurs_runtime.Apply(go__go_7_18_6, gopurs_runtime.Value{Type: 9, IntVal: 525585346, UnsafePtr: unsafe.Pointer((&Constructor_Control_Monad_Rec_Class_Loop{1, gopurs_runtime.Int(1)}))}).IntVal)).StrVal())), gopurs_runtime.Value{})
...
func Get_Main_applyN__1580697421() gopurs_runtime.Value {
	once_Main_applyN__1580697421.Do(func() {
		cache_Main_applyN__1580697421 = func() gopurs_runtime.Value {
			...
			return gopurs_runtime.Apply(go__go_0_0_7, gopurs_runtime.Func(func(x_1 gopurs_runtime.Value) gopurs_runtime.Value {
				return x_1
			}))
		}()
	})
