...
func Get_Main_foo_() gopurs_runtime.Value {
	once_Main_foo_.Do(func() {
		cache_Main_foo_ = gopurs_runtime.Func2(func(dictFoo_0_box gopurs_runtime.Value, x_1_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_foo_(gopurs_runtime.CoerceToStruct[Constructor_Main_Foo](dictFoo_0_box), x_1_box)
		})
	})
	return cache_Main_foo_
}

var cache_Main_foo__1951278162 gopurs_runtime.Value
var once_Main_foo__1951278162 sync.Once

func Get_Main_foo__1951278162() gopurs_runtime.Value {
	once_Main_foo__1951278162.Do(func() {
		cache_Main_foo__1951278162 = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_foo__1951278162(gopurs_runtime.CoerceToStruct[Constructor_Main_Foo](dict_0_box))
		})
	})
	return cache_Main_foo__1951278162
}
...
func Get_Main_foo__3151251028() gopurs_runtime.Value {
	once_Main_foo__3151251028.Do(func() {
		cache_Main_foo__3151251028 = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_foo__3151251028(gopurs_runtime.CoerceToStruct[Constructor_Main_Foo](dict_0_box))
		})
	})
...
func Call_Main_foo_(dictFoo_0_loop *Constructor_Main_Foo, x_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
	var dictFoo_0 *Constructor_Main_Foo = dictFoo_0_loop
	_ = dictFoo_0
...
func Call_Main_foo__1951278162(dict_0_loop *Constructor_Main_Foo) gopurs_runtime.Value {
	var dict_0 *Constructor_Main_Foo = dict_0_loop
	_ = dict_0
	return gopurs_runtime.Box(dict_0.V0)
}

func Call_Main_foo__3151251028(dict_0_loop *Constructor_Main_Foo) gopurs_runtime.Value {
	var dict_0 *Constructor_Main_Foo = dict_0_loop
	_ = dict_0
	return gopurs_runtime.Box(dict_0.V0)
}
