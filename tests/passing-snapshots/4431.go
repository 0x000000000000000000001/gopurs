...
func Call_Main_functorTypedCache(dictFunctor_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
	...
	_ = dictFunctor_0
	return gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer((&Constructor_Data_Functor_Functor[*Constructor_Main_Get[gopurs_runtime.Value, gopurs_runtime.Value]]{1, gopurs_runtime.Func(func(f_1 gopurs_runtime.Value) gopurs_runtime.Value {
