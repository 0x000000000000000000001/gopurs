...
func Get_Main_fooString() gopurs_runtime.Value {
	once_Main_fooString.Do(func() {
		cache_Main_fooString = gopurs_runtime.Value{Type: 9, IntVal: 2763139640, UnsafePtr: unsafe.Pointer((&Constructor_Main_Foo{1, gopurs_runtime.Func(func(s_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Main_foo__1092450768() gopurs_runtime.Value {
	once_Main_foo__1092450768.Do(func() {
		cache_Main_foo__1092450768 = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_foo__1092450768(gopurs_runtime.CoerceToStruct[Constructor_Main_Foo](dict_0_box))
		})
	})
...
func Call_Main_foo__1092450768(dict_0_loop *Constructor_Main_Foo) gopurs_runtime.Value {
	var dict_0 *Constructor_Main_Foo = dict_0_loop
	_ = dict_0
	return gopurs_runtime.Box(dict_0.V0)
}
