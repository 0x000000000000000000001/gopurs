...
func Get_Main_showRecord() gopurs_runtime.Value {
	once_Main_showRecord.Do(func() {
		cache_Main_showRecord = gopurs_runtime.Value{Type: 9, IntVal: 1835580986, UnsafePtr: unsafe.Pointer((&Constructor_Data_Show_Show[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(record_0 gopurs_runtime.Value) gopurs_runtime.Value {
			var __t0 string
			{
...
func Get_Main_showFFI__2742601362() gopurs_runtime.Value {
	once_Main_showFFI__2742601362.Do(func() {
		cache_Main_showFFI__2742601362 = gopurs_runtime.Func(func(dictShow_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_showFFI__2742601362(gopurs_runtime.CoerceToStruct[Constructor_Data_Show_Show[gopurs_runtime.Value]](dictShow_0_box))
		})
	})
...
func Get_Main_main() gopurs_runtime.Value {
	once_Main_main.Do(func() {
		cache_Main_main = gopurs_runtime.Func(func(_ gopurs_runtime.Value) gopurs_runtime.Value {
			...
			__local_var_0_0 := gopurs_runtime.Apply(Get_Effect_Console_log(), gopurs_runtime.Str(gopurs_runtime.Apply2(Get_Main_showImpl(), gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Data_Show_Show[gopurs_runtime.Value]](Get_Main_showRecord()).V0), gopurs_runtime.RecordDict4("a", "b", "c", "e", gopurs_runtime.Int(1), gopurs_runtime.Bool(true), gopurs_runtime.Str("d"), gopurs_runtime.Float(4.0))).StrVal()))
			_ = __local_var_0_0
...
func Call_Main_showFFI__2742601362(dictShow_0_loop *Constructor_Data_Show_Show[gopurs_runtime.Value]) gopurs_runtime.Value {
	var dictShow_0 *Constructor_Data_Show_Show[gopurs_runtime.Value] = dictShow_0_loop
	_ = dictShow_0
	return gopurs_runtime.Apply(Get_Main_showImpl(), gopurs_runtime.Box(dictShow_0.V0))
}
