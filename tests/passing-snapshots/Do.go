...
func Get_Main_functorMaybe() gopurs_runtime.Value {
	once_Main_functorMaybe.Do(func() {
		cache_Main_functorMaybe = gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer((&Constructor_Data_Functor_Functor[*Constructor_Main_Just[gopurs_runtime.Value]]{1, gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Main_test4() gopurs_runtime.Value {
	once_Main_test4.Do(func() {
		cache_Main_test4 = gopurs_runtime.Func2(func(mx_0_box gopurs_runtime.Value, my_1_box gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Value{Type: 9, IntVal: 3271839782, UnsafePtr: unsafe.Pointer(Call_Main_test4(gopurs_runtime.CoerceToStruct[Constructor_Main_Just[float64]](mx_0_box), gopurs_runtime.CoerceToStruct[Constructor_Main_Just[float64]](my_1_box)))}
		})
	})
...
func Get_Main_test5() gopurs_runtime.Value {
	once_Main_test5.Do(func() {
		cache_Main_test5 = gopurs_runtime.Func3(func(mx_0_box gopurs_runtime.Value, my_1_box gopurs_runtime.Value, mz_2_box gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Value{Type: 9, IntVal: 3271839782, UnsafePtr: unsafe.Pointer(Call_Main_test5(gopurs_runtime.CoerceToStruct[Constructor_Main_Just[float64]](mx_0_box), gopurs_runtime.CoerceToStruct[Constructor_Main_Just[float64]](my_1_box), gopurs_runtime.CoerceToStruct[Constructor_Main_Just[float64]](mz_2_box)))}
		})
	})
...
func Call_Main_test8(v_0_loop gopurs_runtime.Value) *Constructor_Main_Just[*Constructor_Main_Just[float64]] {
	...
	_ = v_0
	return (&Constructor_Main_Just[*Constructor_Main_Just[float64]]{1, gopurs_runtime.Value{Type: 9, IntVal: 3271839782, UnsafePtr: unsafe.Pointer((&Constructor_Main_Just[gopurs_runtime.Value]{1, gopurs_runtime.Float(1.0)}))}})
}
...
func Call_Main_test6(dictPartial_0_loop gopurs_runtime.Value, mx_1_loop gopurs_runtime.Value, v_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
	...
	{
		var __t_tag_0 *Constructor_Main_Just[gopurs_runtime.Value] = gopurs_runtime.CoerceToStruct[Constructor_Main_Just[gopurs_runtime.Value]](mx_1)
		if __t_tag_0 != nil {
			__t1 = (*Constructor_Main_Just[gopurs_runtime.Value])(mx_1.UnsafePtr).V0
			goto end_branch_1
		} else {
...
end_branch_1:
	return gopurs_runtime.Value{Type: 9, IntVal: 3271839782, UnsafePtr: unsafe.Pointer((&Constructor_Main_Just[gopurs_runtime.Value]{1, __t1}))}
}
...
func Call_Main_test10(v_0_loop gopurs_runtime.Value) *Constructor_Main_Just[float64] {
	...
	return (&Constructor_Main_Just[float64]{1, gopurs_runtime.Apply(f_1_1_1, gopurs_runtime.Float(10.0))})
}

func Call_Main_test1(v_0_loop gopurs_runtime.Value) *Constructor_Main_Just[string] {
	var v_0 gopurs_runtime.Value = v_0_loop
	_ = v_0
	return (&Constructor_Main_Just[string]{1, gopurs_runtime.Str("abc")})
}

func Call_Main_test2(v_0_loop gopurs_runtime.Value) *Constructor_Main_Just[float64] {
	var v_0 gopurs_runtime.Value = v_0_loop
	_ = v_0
	return (&Constructor_Main_Just[float64]{1, gopurs_runtime.Float(3.0)})
}

func Call_Main_test3(v_0_loop gopurs_runtime.Value) *Constructor_Main_Just[float64] {
	var v_0 gopurs_runtime.Value = v_0_loop
	_ = v_0
	return gopurs_runtime.CoerceToStruct[Constructor_Main_Just[float64]](gopurs_runtime.Value{Type: 9, IntVal: 3271839782, UnsafePtr: unsafe.Pointer((*Constructor_Main_Just[gopurs_runtime.Value])(nil))})
}
...
func Call_Main_test4(mx_0_loop *Constructor_Main_Just[float64], my_1_loop *Constructor_Main_Just[float64]) *Constructor_Main_Just[float64] {
	...
	}
	{
		if mx_0 != nil {
			...
			{
				if my_1 != nil {
					__t0 = gopurs_runtime.Value{Type: 9, IntVal: 3271839782, UnsafePtr: unsafe.Pointer((&Constructor_Main_Just[float64]{1, gopurs_runtime.Float((((mx_0).V0.FloatVal()) + ((my_1).V0.FloatVal())) + (1.0))}))}
					goto end_branch_0
				} else {
...
end_branch_1:
	return gopurs_runtime.CoerceToStruct[Constructor_Main_Just[float64]](gopurs_runtime.Value{Type: 9, IntVal: 3271839782, UnsafePtr: unsafe.Pointer(__t1)})
}
...
func Call_Main_test5(mx_0_loop *Constructor_Main_Just[float64], my_1_loop *Constructor_Main_Just[float64], mz_2_loop *Constructor_Main_Just[float64]) *Constructor_Main_Just[float64] {
		...
		if mx_0 != nil {
			...
			}
			{
				if my_1 != nil {
					...
					{
						if mz_2 != nil {
							__t1 = gopurs_runtime.Value{Type: 9, IntVal: 3271839782, UnsafePtr: unsafe.Pointer((&Constructor_Main_Just[float64]{1, gopurs_runtime.Float((((mz_2).V0.FloatVal()) + (sum_3_0)) + (1.0))}))}
							goto end_branch_1
						} else {
			...
			{
				__t2 = gopurs_runtime.CoerceToStruct[Constructor_Main_Just[gopurs_runtime.Value]](func() gopurs_runtime.Value { panic("Failed pattern match") }())
			}
		end_branch_2:
			__t3 = __t2
			goto end_branch_3
	...
	{
		__t3 = gopurs_runtime.CoerceToStruct[Constructor_Main_Just[gopurs_runtime.Value]](func() gopurs_runtime.Value { panic("Failed pattern match") }())
	}
end_branch_3:
	return gopurs_runtime.CoerceToStruct[Constructor_Main_Just[float64]](gopurs_runtime.Value{Type: 9, IntVal: 3271839782, UnsafePtr: unsafe.Pointer(__t3)})
}

func Call_Main_test9(v_0_loop gopurs_runtime.Value) *Constructor_Main_Just[float64] {
	var v_0 gopurs_runtime.Value = v_0_loop
	_ = v_0
	return gopurs_runtime.CoerceToStruct[Constructor_Main_Just[float64]](gopurs_runtime.Value{Type: 9, IntVal: 3271839782, UnsafePtr: unsafe.Pointer((&Constructor_Main_Just[gopurs_runtime.Value]{1, gopurs_runtime.Float(3.0)}))})
}
