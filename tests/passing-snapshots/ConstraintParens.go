...
func Get_Main_test() gopurs_runtime.Value {
	once_Main_test.Do(func() {
		cache_Main_test = gopurs_runtime.Func(func(dictFoo_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_test(gopurs_runtime.CoerceToStruct[Constructor_Main_Foo](dictFoo_0_box))
		})
	})
...
func Call_Main_test(dictFoo_0_loop *Constructor_Main_Foo) gopurs_runtime.Value {
