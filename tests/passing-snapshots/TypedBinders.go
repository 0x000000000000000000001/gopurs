...
func Get_Main_test4() gopurs_runtime.Value {
	once_Main_test4.Do(func() {
		cache_Main_test4 = gopurs_runtime.Func(func(v_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Value{Type: 9, IntVal: 3562159846, UnsafePtr: unsafe.Pointer(Call_Main_test4(gopurs_runtime.CoerceToStruct[Constructor_Main_Tuple](v_0_box)))}
		})
	})
...
func Get_Main_monadStateState() gopurs_runtime.Value {
	once_Main_monadStateState.Do(func() {
		cache_Main_monadStateState = gopurs_runtime.Value{Type: 9, IntVal: 2980279296, UnsafePtr: unsafe.Pointer((&Constructor_Main_MonadState{1, gopurs_runtime.Func(func(s_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Main_modify() gopurs_runtime.Value {
	once_Main_modify.Do(func() {
		cache_Main_modify = gopurs_runtime.Func(func(dictMonad_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_modify(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Monad](dictMonad_0_box))
		})
	})
...
func Get_Main_applicativeState__512641780() gopurs_runtime.Value {
	once_Main_applicativeState__512641780.Do(func() {
		cache_Main_applicativeState__512641780 = gopurs_runtime.Value{Type: 9, IntVal: 1459134221, UnsafePtr: unsafe.Pointer((&Constructor_Control_Applicative_Applicative{1, gopurs_runtime.Func(func(_dollar___unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Value{Type: 9, IntVal: 3032403085, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Apply_Apply](Get_Main_applyState()))}
		}), gopurs_runtime.Func(func(a_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Func(func(s_1 gopurs_runtime.Value) gopurs_runtime.Value {
				return gopurs_runtime.Value{Type: 9, IntVal: 3562159846, UnsafePtr: unsafe.Pointer((&Constructor_Main_Tuple{1, s_1, a_0}))}
...
var cache_Main_applyState__1706849652 gopurs_runtime.Value
var once_Main_applyState__1706849652 sync.Once

func Get_Main_applyState__1706849652() gopurs_runtime.Value {
	once_Main_applyState__1706849652.Do(func() {
		cache_Main_applyState__1706849652 = gopurs_runtime.Value{Type: 9, IntVal: 3032403085, UnsafePtr: unsafe.Pointer((&Constructor_Control_Apply_Apply{1, gopurs_runtime.Func(func(_dollar___unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor](Get_Main_functorState()))}
		}), gopurs_runtime.Func(func(f_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Func(func(a_1 gopurs_runtime.Value) gopurs_runtime.Value {
				return gopurs_runtime.Func(func(s_2 gopurs_runtime.Value) gopurs_runtime.Value {
	...
	return cache_Main_applyState__1706849652
}
...
func Get_Main_bindState__1148353140() gopurs_runtime.Value {
	once_Main_bindState__1148353140.Do(func() {
		cache_Main_bindState__1148353140 = gopurs_runtime.Value{Type: 9, IntVal: 4032919565, UnsafePtr: unsafe.Pointer((&Constructor_Control_Bind_Bind{1, gopurs_runtime.Func(func(_dollar___unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Value{Type: 9, IntVal: 3032403085, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Apply_Apply](Get_Main_applyState()))}
		}), gopurs_runtime.Func(func(f_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Func(func(g_1 gopurs_runtime.Value) gopurs_runtime.Value {
				return gopurs_runtime.Func(func(s_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
var cache_Main_functorState__1545512803 gopurs_runtime.Value
var once_Main_functorState__1545512803 sync.Once

func Get_Main_functorState__1545512803() gopurs_runtime.Value {
	once_Main_functorState__1545512803.Do(func() {
	...
	return cache_Main_functorState__1545512803
}
...
func Call_Main_test4(v_0_loop *Constructor_Main_Tuple) *Constructor_Main_Tuple {
	var v_0 *Constructor_Main_Tuple = v_0_loop
	_ = v_0
	return gopurs_runtime.CoerceToStruct[Constructor_Main_Tuple](gopurs_runtime.Value{Type: 9, IntVal: 3562159846, UnsafePtr: unsafe.Pointer((&Constructor_Main_Tuple{1, (v_0).V1, (v_0).V0}))})
}
...
func Call_Main_modify1(f_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
	...
	_ = f_0
	return gopurs_runtime.Func(func(s_1 gopurs_runtime.Value) gopurs_runtime.Value {
		return gopurs_runtime.Value{Type: 9, IntVal: 3562159846, UnsafePtr: unsafe.Pointer((&Constructor_Main_Tuple{1, gopurs_runtime.Apply(f_0, s_1), Get_Data_Unit_unit()}))}
	})
}
