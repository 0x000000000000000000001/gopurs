...
func Get_Main_L() gopurs_runtime.Value {
	once_Main_L.Do(func() {
		cache_Main_L = gopurs_runtime.Func(func(value0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Value{Type: 9, IntVal: 4133812178, UnsafePtr: unsafe.Pointer((&Constructor_Main_L{1, value0}))}
		})
	})
	return cache_Main_L
}
...
func Get_Main_R() gopurs_runtime.Value {
	once_Main_R.Do(func() {
		cache_Main_R = gopurs_runtime.Func(func(value0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Value{Type: 9, IntVal: 3558538316, UnsafePtr: unsafe.Pointer((&Constructor_Main_R{1, value0}))}
		})
	})
	return cache_Main_R
}
...
func Get_Main_lefts() gopurs_runtime.Value {
	once_Main_lefts.Do(func() {
		cache_Main_lefts = func() gopurs_runtime.Value {
			...
			go__go_0_0_0 = gopurs_runtime.Func(func(v_1_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
				return gopurs_runtime.Func(func(v1_2_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
					return func() gopurs_runtime.Value {
						var v_1_loop *Constructor_Main_C = gopurs_runtime.CoerceToStruct[Constructor_Main_C](v_1_loop_val)
					...
					go__go_0_0_0:
						for {
							...
							var v_1 *Constructor_Main_C = v_1_loop
							_ = v_1
							var v1_2 gopurs_runtime.Value = v1_2_loop
							_ = v1_2
							var __t3 *Constructor_Main_C
							{
							...
							{
								if v1_2.Type == 9 && v1_2.IntVal == 2167983901 && v1_2.UnsafePtr != nil {
									var __t2 *Constructor_Main_C
									{
										var __t_tag_1 gopurs_runtime.Value = (*Constructor_Main_C)(v1_2.UnsafePtr).V0
										if __t_tag_1.Type == 9 && __t_tag_1.IntVal == 4133812178 {
											v_1_loop = gopurs_runtime.CoerceToStruct[Constructor_Main_C](gopurs_runtime.Value{Type: 9, IntVal: 2167983901, UnsafePtr: unsafe.Pointer((&Constructor_Main_C{1, (*Constructor_Main_L)((*Constructor_Main_C)(v1_2.UnsafePtr).V0.UnsafePtr).V0, v_1}))})
											v1_2_loop = gopurs_runtime.Value{Type: 9, IntVal: 2167983901, UnsafePtr: unsafe.Pointer((*Constructor_Main_C)(v1_2.UnsafePtr).V1)}
											continue go__go_0_0_0
											__t2 = gopurs_runtime.CoerceToStruct[Constructor_Main_C](gopurs_runtime.Value{})
											goto end_branch_2
										} else {
							...
							{
								__t3 = gopurs_runtime.CoerceToStruct[Constructor_Main_C](func() gopurs_runtime.Value { panic("Failed pattern match") }())
							}
						end_branch_3:
			...
			return gopurs_runtime.Apply(go__go_0_0_0, gopurs_runtime.Value{Type: 9, IntVal: 2167983901, UnsafePtr: unsafe.Pointer((*Constructor_Main_C)(nil))})
		}()
	})
...
type Constructor_Main_L struct {
	Rc uint32
	V0 gopurs_runtime.Value
}
