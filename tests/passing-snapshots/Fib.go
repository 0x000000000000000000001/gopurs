	...
	once_Main_fib.Do(func() {
		cache_Main_fib = gopurs_runtime.Float(gopurs_runtime.Apply(Get_Control_Monad_ST_Internal_run(), gopurs_runtime.Func(func(_ gopurs_runtime.Value) gopurs_runtime.Value {
			...
			return gopurs_runtime.Apply(gopurs_runtime.Apply2(Call_Control_Bind_bind(gopurs_runtime.CoerceToStruct[Constructor_Control_Bind_Bind[gopurs_runtime.Value]](Get_Control_Monad_ST_Internal_bindST())), gopurs_runtime.Apply2(Get_Control_Monad_ST_Internal_while(), gopurs_runtime.Func(func(_ gopurs_runtime.Value) gopurs_runtime.Value {
				__local_var_3_3 := (*(n1_1_1.PtrVal().(*interface{}))).(gopurs_runtime.Value)
				_ = __local_var_3_3
				var __t_tag_4 gopurs_runtime.Value = gopurs_runtime.Apply5(Get_Data_Ord_ordNumberImpl(), gopurs_runtime.Value{Type: 9, IntVal: int64(1527465420), UnsafePtr: nil}, gopurs_runtime.Value{Type: 9, IntVal: int64(902936544), UnsafePtr: nil}, gopurs_runtime.Value{Type: 9, IntVal: int64(380165415), UnsafePtr: nil}, gopurs_runtime.Float(1000.0), __local_var_3_3)
				_ = __t_tag_4
				return gopurs_runtime.Bool((uint32(__t_tag_4.IntVal) == 380165415))
			}), gopurs_runtime.Func(func(_ gopurs_runtime.Value) gopurs_runtime.Value {
				n1_prime__3_5 := (*(n1_1_1.PtrVal().(*interface{}))).(gopurs_runtime.Value)
				_ = n1_prime__3_5
				n2_prime__4_6 := (*(n2_2_2.PtrVal().(*interface{}))).(gopurs_runtime.Value)
				_ = n2_prime__4_6
				*(n2_2_2.PtrVal().(*interface{})) = gopurs_runtime.Float((n1_prime__3_5.FloatVal()) + (n2_prime__4_6.FloatVal()))
				_dollar___unused_5_7 := gopurs_runtime.Float((n1_prime__3_5.FloatVal()) + (n2_prime__4_6.FloatVal()))
				_ = _dollar___unused_5_7
				*(n1_1_1.PtrVal().(*interface{})) = n2_prime__4_6
				return n2_prime__4_6
