...
func Get_Main_prj__1257140861() gopurs_runtime.Value {
	once_Main_prj__1257140861.Do(func() {
		cache_Main_prj__1257140861 = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_prj__1257140861(gopurs_runtime.CoerceToStruct[Constructor_Main_Inject[gopurs_runtime.Value, gopurs_runtime.Value]](dict_0_box))
		})
	})
...
func Get_Main_injectRefl() gopurs_runtime.Value {
	once_Main_injectRefl.Do(func() {
		cache_Main_injectRefl = gopurs_runtime.Value{Type: 9, IntVal: 930202529, UnsafePtr: unsafe.Pointer((&Constructor_Main_Inject[gopurs_runtime.Value, gopurs_runtime.Value]{1, gopurs_runtime.Func(func(x_0 gopurs_runtime.Value) gopurs_runtime.Value {
			...
			return gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer((&Constructor_Data_Maybe_Just[gopurs_runtime.Value]{1, x_0}))}
		})}))}
	})
		...
		cache_Main_injectLeft = gopurs_runtime.Value{Type: 9, IntVal: 930202529, UnsafePtr: unsafe.Pointer((&Constructor_Main_Inject[gopurs_runtime.Value, gopurs_runtime.Value]{1, gopurs_runtime.Func(func(x_0 gopurs_runtime.Value) gopurs_runtime.Value {
			...
			var __t0 *Constructor_Data_Maybe_Just[gopurs_runtime.Value]
			{
				if v_0.Type == 9 && v_0.IntVal == 3711209382 {
					__t0 = (&Constructor_Data_Maybe_Just[gopurs_runtime.Value]{1, (*Constructor_Data_Either_Left[gopurs_runtime.Value, gopurs_runtime.Value])(v_0.UnsafePtr).V0})
					goto end_branch_0
				} else {
...
func Get_Main_injectLeft__4013048200() gopurs_runtime.Value {
	once_Main_injectLeft__4013048200.Do(func() {
		cache_Main_injectLeft__4013048200 = gopurs_runtime.Value{Type: 9, IntVal: 930202529, UnsafePtr: unsafe.Pointer((&Constructor_Main_Inject[gopurs_runtime.Value, gopurs_runtime.Value]{1, gopurs_runtime.Func(func(x_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Value{Type: 9, IntVal: 3711209382, UnsafePtr: unsafe.Pointer((&Constructor_Data_Either_Left[gopurs_runtime.Value, gopurs_runtime.Value]{1, x_0}))}
		}), gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
			var __t0 *Constructor_Data_Maybe_Just[gopurs_runtime.Value]
			{
...
func Get_Main_inj__2246686172() gopurs_runtime.Value {
	once_Main_inj__2246686172.Do(func() {
		cache_Main_inj__2246686172 = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_inj__2246686172(gopurs_runtime.CoerceToStruct[Constructor_Main_Inject[gopurs_runtime.Value, gopurs_runtime.Value]](dict_0_box))
		})
	})
...
func init() {
	gopurs_runtime.StructGetters[930202529] = func(ptr unsafe.Pointer, key string) gopurs_runtime.Value {
		c := (*Constructor_Main_Inject[any, any])(ptr)
		_ = c
		switch key {
		case "inj":
...
func Call_Main_prj__1257140861(dict_0_loop *Constructor_Main_Inject[gopurs_runtime.Value, gopurs_runtime.Value]) gopurs_runtime.Value {
	var dict_0 *Constructor_Main_Inject[gopurs_runtime.Value, gopurs_runtime.Value] = dict_0_loop
	_ = dict_0
	return gopurs_runtime.Box(dict_0.V1)
}
...
func Call_Main_inj__2246686172(dict_0_loop *Constructor_Main_Inject[gopurs_runtime.Value, gopurs_runtime.Value]) gopurs_runtime.Value {
	var dict_0 *Constructor_Main_Inject[gopurs_runtime.Value, gopurs_runtime.Value] = dict_0_loop
	_ = dict_0
	return gopurs_runtime.Box(dict_0.V0)
}
