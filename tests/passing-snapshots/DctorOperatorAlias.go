...
func Get_Main_get3__3420859751() gopurs_runtime.Value {
	once_Main_get3__3420859751.Do(func() {
		cache_Main_get3__3420859751 = gopurs_runtime.Func2(func(v_0_box gopurs_runtime.Value, v1_1_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_get3__3420859751(v_0_box, gopurs_runtime.CoerceToStruct[Constructor_List_Cons[gopurs_runtime.Value]](v1_1_box))
		})
	})
...
func Get_Main_get2__3420859751() gopurs_runtime.Value {
	once_Main_get2__3420859751.Do(func() {
		cache_Main_get2__3420859751 = gopurs_runtime.Func2(func(v_0_box gopurs_runtime.Value, v1_1_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_get2__3420859751(v_0_box, gopurs_runtime.CoerceToStruct[Constructor_List_Cons[gopurs_runtime.Value]](v1_1_box))
		})
	})
...
func Get_Main_get1__3420859751() gopurs_runtime.Value {
	once_Main_get1__3420859751.Do(func() {
		cache_Main_get1__3420859751 = gopurs_runtime.Func2(func(y_0_box gopurs_runtime.Value, xs_1_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_get1__3420859751(y_0_box, gopurs_runtime.CoerceToStruct[Constructor_List_Cons[gopurs_runtime.Value]](xs_1_box))
		})
	})
...
func Call_Main_get3__3420859751(v_0_loop gopurs_runtime.Value, v1_1_loop *Constructor_List_Cons[gopurs_runtime.Value]) gopurs_runtime.Value {
	var v_0 gopurs_runtime.Value = v_0_loop
	_ = v_0
	var v1_1 *Constructor_List_Cons[gopurs_runtime.Value] = v1_1_loop
	_ = v1_1
...
func Call_Main_get2__3420859751(v_0_loop gopurs_runtime.Value, v1_1_loop *Constructor_List_Cons[gopurs_runtime.Value]) gopurs_runtime.Value {
	var v_0 gopurs_runtime.Value = v_0_loop
	_ = v_0
	var v1_1 *Constructor_List_Cons[gopurs_runtime.Value] = v1_1_loop
	_ = v1_1
...
func Call_Main_get1__3420859751(y_0_loop gopurs_runtime.Value, xs_1_loop *Constructor_List_Cons[gopurs_runtime.Value]) gopurs_runtime.Value {
	var y_0 gopurs_runtime.Value = y_0_loop
	_ = y_0
	var xs_1 *Constructor_List_Cons[gopurs_runtime.Value] = xs_1_loop
	_ = xs_1
