...
func Get_Main_test7() gopurs_runtime.Value {
	once_Main_test7.Do(func() {
		cache_Main_test7 = gopurs_runtime.Float(1.0)
	})
...
func Get_Main_test5() gopurs_runtime.Value {
	once_Main_test5.Do(func() {
		cache_Main_test5 = func() gopurs_runtime.Value {
			var f__512709115_0_0_2 gopurs_runtime.Value
			_ = f__512709115_0_0_2
			var f__512709115_0_0_2_cell *gopurs_runtime.Value
			_ = f__512709115_0_0_2_cell
			...
			_ = f_0_2_4_cell
			// FALLBACK TCO: isLoop=false len=3
			f__512709115_0_0_2 = gopurs_runtime.Func(func(v_1 gopurs_runtime.Value) gopurs_runtime.Value {
				var __t4 float64
				{
					...
					if uint32(__t_tag_3.IntVal) == 380165415 {
						__t4 = (gopurs_runtime.Apply((*g_0_1_3_cell), gopurs_runtime.Float((v_1.FloatVal())/(2.0))).FloatVal()) + (1.0)
						goto end_branch_4
					} else {
			...
			f__512709115_0_0_2_cell = &f__512709115_0_0_2
			g_0_1_3 = gopurs_runtime.Func(func(x_1 gopurs_runtime.Value) gopurs_runtime.Value {
				return gopurs_runtime.Float((gopurs_runtime.Apply((*f__512709115_0_0_2_cell), gopurs_runtime.Float((x_1.FloatVal())-(1.0))).FloatVal()) + (1.0))
			})
			...
			f_0_2_4 = gopurs_runtime.Func(func(v_1 gopurs_runtime.Value) gopurs_runtime.Value {
				var __t6 float64
				{
					...
					if uint32(__t_tag_5.IntVal) == 380165415 {
						__t6 = (gopurs_runtime.Apply((*g_0_1_3_cell), gopurs_runtime.Float((v_1.FloatVal())/(2.0))).FloatVal()) + (1.0)
						goto end_branch_6
					} else {
			...
			end_branch_6:
				return gopurs_runtime.Float(__t6)
			})
			f_0_2_4_cell = &f_0_2_4
			return gopurs_runtime.Float(gopurs_runtime.Apply(f__512709115_0_0_2, gopurs_runtime.Float(10.0)).FloatVal())
		}()
	})
					...
					return gopurs_runtime.Apply2(Call_Control_Bind_bind(gopurs_runtime.CoerceToStruct[Constructor_Control_Bind_Bind[gopurs_runtime.Value]](Get_Effect_bindEffect())), gopurs_runtime.Apply(Get_Effect_Console_log(), gopurs_runtime.Str(gopurs_runtime.Apply(Get_Data_Show_showNumberImpl(), gopurs_runtime.Float(gopurs_runtime.Apply2(Call_Data_Semiring_add(Rebox_Main_602713622_2826095630(Rebox_Main_2826095630_602713622(gopurs_runtime.CoerceToStruct[Constructor_Data_Semiring_Semiring[gopurs_runtime.Value]](Get_Data_Semiring_semiringNumber())))), gopurs_runtime.Float(gopurs_runtime.ArrayAccess(func() gopurs_runtime.Value {
						...
						return gopurs_runtime.Apply2(Call_Control_Bind_bind(gopurs_runtime.CoerceToStruct[Constructor_Control_Bind_Bind[gopurs_runtime.Value]](Get_Effect_bindEffect())), gopurs_runtime.Apply(Get_Effect_Console_log(), gopurs_runtime.Str(gopurs_runtime.Apply(Get_Data_Show_showNumberImpl(), gopurs_runtime.Float(Get_Main_test5().FloatVal())).StrVal())), gopurs_runtime.Func(func(_dollar___unused_4 gopurs_runtime.Value) gopurs_runtime.Value {
							return gopurs_runtime.Apply2(Call_Control_Bind_bind(gopurs_runtime.CoerceToStruct[Constructor_Control_Bind_Bind[gopurs_runtime.Value]](Get_Effect_bindEffect())), gopurs_runtime.Apply(Get_Effect_Console_log(), gopurs_runtime.Str(gopurs_runtime.Apply(Get_Data_Show_showNumberImpl(), gopurs_runtime.Float(1.0)).StrVal())), gopurs_runtime.Func(func(_dollar___unused_5 gopurs_runtime.Value) gopurs_runtime.Value {
								return gopurs_runtime.Apply2(Call_Control_Bind_bind(gopurs_runtime.CoerceToStruct[Constructor_Control_Bind_Bind[gopurs_runtime.Value]](Get_Effect_bindEffect())), gopurs_runtime.Apply(Get_Effect_Console_log(), gopurs_runtime.Str(gopurs_runtime.Apply(Get_Data_Show_showNumberImpl(), gopurs_runtime.Float(Call_Main_test8(100.0))).StrVal())), gopurs_runtime.Func(func(_dollar___unused_6 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_Main_test10(v_0_loop gopurs_runtime.Value) float64 {
	...
	_ = v_0
	var f__512709115_1_0_5 gopurs_runtime.Value
	_ = f__512709115_1_0_5
	var f__512709115_1_0_5_cell *gopurs_runtime.Value
	_ = f__512709115_1_0_5_cell
	// FALLBACK TCO: isLoop=false len=3
	var g_1_1_6 gopurs_runtime.Value
	_ = g_1_1_6
	var g_1_1_6_cell *gopurs_runtime.Value
	_ = g_1_1_6_cell
	// FALLBACK TCO: isLoop=false len=3
	var f_1_2_7 gopurs_runtime.Value
	_ = f_1_2_7
	var f_1_2_7_cell *gopurs_runtime.Value
	_ = f_1_2_7_cell
	// FALLBACK TCO: isLoop=false len=3
	f__512709115_1_0_5 = gopurs_runtime.Func(func(x_2 gopurs_runtime.Value) gopurs_runtime.Value {
		return gopurs_runtime.Float((gopurs_runtime.Apply((*g_1_1_6_cell), gopurs_runtime.Float(x_2.FloatVal())).FloatVal()) * (3.0))
	})
	f__512709115_1_0_5_cell = &f__512709115_1_0_5
	g_1_1_6 = gopurs_runtime.Func(func(x_2 gopurs_runtime.Value) gopurs_runtime.Value {
		return gopurs_runtime.Float((gopurs_runtime.Apply((*f__512709115_1_0_5_cell), gopurs_runtime.Float(x_2.FloatVal())).FloatVal()) / (2.0))
	})
	g_1_1_6_cell = &g_1_1_6
	f_1_2_7 = gopurs_runtime.Func(func(x_2 gopurs_runtime.Value) gopurs_runtime.Value {
		return gopurs_runtime.Float((gopurs_runtime.Apply((*g_1_1_6_cell), gopurs_runtime.Float(x_2.FloatVal())).FloatVal()) * (3.0))
	})
	f_1_2_7_cell = &f_1_2_7
	return gopurs_runtime.Apply(f__512709115_1_0_5, gopurs_runtime.Float(10.0)).FloatVal()
}
