...
func Get_Main_convertSB() gopurs_runtime.Value {
	once_Main_convertSB.Do(func() {
		cache_Main_convertSB = gopurs_runtime.Value{Type: 9, IntVal: 3639075177, UnsafePtr: unsafe.Pointer((&Constructor_Main_Convert{1, gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
			var __t0 string
			{
				if (v_0.IntVal) == (0) {
					__t0 = "Nope"
...
func Get_Main_convert() gopurs_runtime.Value {
	once_Main_convert.Do(func() {
		cache_Main_convert = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_convert(gopurs_runtime.CoerceToStruct[Constructor_Main_Convert](dict_0_box))
		})
	})
...
func Get_Main_convert__769515702() gopurs_runtime.Value {
	once_Main_convert__769515702.Do(func() {
		cache_Main_convert__769515702 = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_convert__769515702(gopurs_runtime.CoerceToStruct[Constructor_Main_Convert](dict_0_box))
		})
	})
	return cache_Main_convert__769515702
}

type Constructor_Main_Convert struct {
	Rc uint32
...
func init() {
	gopurs_runtime.StructGetters[3639075177] = func(ptr unsafe.Pointer, key string) gopurs_runtime.Value {
		c := (*Constructor_Main_Convert)(ptr)
		_ = c
		switch key {
		case "convert":
...
func Call_Main_convert(dict_0_loop *Constructor_Main_Convert) gopurs_runtime.Value {
	var dict_0 *Constructor_Main_Convert = dict_0_loop
	_ = dict_0
	return gopurs_runtime.Box(dict_0.V0)
}

func Call_Main_convert__769515702(dict_0_loop *Constructor_Main_Convert) gopurs_runtime.Value {
	var dict_0 *Constructor_Main_Convert = dict_0_loop
	_ = dict_0
	return gopurs_runtime.Box(dict_0.V0)
}
