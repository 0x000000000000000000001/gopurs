...
func Get_Main_Bar() gopurs_runtime.Value {
	once_Main_Bar.Do(func() {
		cache_Main_Bar = gopurs_runtime.Value{Type: 9, IntVal: 2763139640, UnsafePtr: unsafe.Pointer((*Constructor_Main_Foo)(nil))}
	})
...
func Call_Main_foo(dictPartial_0_loop gopurs_runtime.Value, v_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
	...
	_ = v_1
	var __t0 *Constructor_Main_Foo
	{
		if (v_1.Type == 9 && v_1.IntVal == 2763139640 && v_1.UnsafePtr != nil) && ((gopurs_runtime.Int(int64(gopurs_runtime.ArrayLength((*Constructor_Main_Foo)(v_1.UnsafePtr).V0))).IntVal) == (0)) {
			__t0 = (*Constructor_Main_Foo)(nil)
			goto end_branch_0
		} else {
	...
	{
		__t0 = gopurs_runtime.CoerceToStruct[Constructor_Main_Foo](func() gopurs_runtime.Value { panic("Failed pattern match") }())
	}
end_branch_0:
