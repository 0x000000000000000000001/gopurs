	...
	once_Main_eqMaybe.Do(func() {
		cache_Main_eqMaybe = gopurs_runtime.Value{Type: 9, IntVal: 1012063514, UnsafePtr: unsafe.Pointer(&Constructor_Data_Eq_Eq{1, gopurs_runtime.Func(func(x_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Func(func(y_1 gopurs_runtime.Value) gopurs_runtime.Value {
				...
				{
					__t0 = (x_0.Type == 9 && x_0.IntVal == 930809136 && x_0.UnsafePtr != nil) && ((y_1.Type == 9 && y_1.IntVal == 930809136 && y_1.UnsafePtr != nil) && (((*Constructor_Data_Maybe_Just)(x_0.UnsafePtr).V0.StrVal()) == ((*Constructor_Data_Maybe_Just)(y_1.UnsafePtr).V0.StrVal())))
				}
			end_branch_0:
...
func Get_Main_runtimeImport() gopurs_runtime.Value {
	once_Main_runtimeImport.Do(func() {
		cache_Main_runtimeImport = gopurs_runtime.Apply2(Get_Main_runtimeImportImpl(), gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer((*Constructor_Data_Maybe_Just)(nil))}, Get_Data_Maybe_Just())
	})
	...
	once_Main_complicatedIdentity.Do(func() {
		cache_Main_complicatedIdentity = func() gopurs_runtime.Value {
			...
			f_0_2_2 = gopurs_runtime.Func(func(n_1 gopurs_runtime.Value) gopurs_runtime.Value {
				...
				{
					__t3 = gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(f_0_2_2, gopurs_runtime.Int((n_1.IntVal)-(1))), "tock"), gopurs_runtime.Func(func(x_2 gopurs_runtime.Value) gopurs_runtime.Value {
						return x_2
					}))
				}
			end_branch_3:
					...
					return gopurs_runtime.Apply(gopurs_runtime.Apply2(Get_Main_runtimeImport(), gopurs_runtime.Str("InitializationError"), gopurs_runtime.Func(func(err3_7 gopurs_runtime.Value) gopurs_runtime.Value {
						...
						var __t18 string
						{
							if (gopurs_runtime.RecordGet(__local_var_8_13, "actual").IntVal) != (0) {
								__t18 = ("Expected: true\x0aActual:   ") + ("true")
								goto end_branch_18
							} else {
						...
						{
							__t18 = ("Expected: true\x0aActual:   ") + ("false")
						}
					end_branch_18:
						// TAST (Let): message_10_17 -> gopurs_runtime.Value
						var message_10_17 gopurs_runtime.Value = gopurs_runtime.Str(__t18)
						// TAST (Let): __local_var_11_19 -> gopurs_runtime.Value
						__local_var_11_19 := gopurs_runtime.Apply(Get_Effect_Console_error(), gopurs_runtime.Str(message_10_17.StrVal()))
						_ = __local_var_11_19
						var __t21 gopurs_runtime.Value
						{
							if ((__local_var_9_15.IntVal) != (0)) != (true) {
...
func Get_Main_runtimeImport__1627706496() gopurs_runtime.Value {
	once_Main_runtimeImport__1627706496.Do(func() {
		cache_Main_runtimeImport__1627706496 = gopurs_runtime.Apply2(Get_Main_runtimeImportImpl(), gopurs_runtime.Value{Type: 9, IntVal: 930809136, UnsafePtr: unsafe.Pointer((*Constructor_Data_Maybe_Just)(nil))}, Get_Data_Maybe_Just())
	})
