...
func Get_Main_profunctorMonoAndPro() gopurs_runtime.Value {
	once_Main_profunctorMonoAndPro.Do(func() {
		cache_Main_profunctorMonoAndPro = gopurs_runtime.Value{Type: 9, IntVal: 2367018778, UnsafePtr: unsafe.Pointer((&Constructor_Data_Profunctor_Profunctor[gopurs_runtime.Value]{1, gopurs_runtime.Func3(func(v_0 gopurs_runtime.Value, v1_1 gopurs_runtime.Value, v2_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Main_profunctorExclusivelyPro() gopurs_runtime.Value {
	once_Main_profunctorExclusivelyPro.Do(func() {
		cache_Main_profunctorExclusivelyPro = gopurs_runtime.Value{Type: 9, IntVal: 2367018778, UnsafePtr: unsafe.Pointer((&Constructor_Data_Profunctor_Profunctor[gopurs_runtime.Value]{1, gopurs_runtime.Func3(func(f_0 gopurs_runtime.Value, g_1 gopurs_runtime.Value, m_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Main_functorTest4() gopurs_runtime.Value {
	once_Main_functorTest4.Do(func() {
		cache_Main_functorTest4 = gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer((&Constructor_Data_Functor_Functor[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(f_0 gopurs_runtime.Value, m_1 gopurs_runtime.Value) gopurs_runtime.Value {
			return func() gopurs_runtime.Value { panic("Failed pattern match") }()
		})}))}
	})
...
func Get_Main_functorMonoAndPro() gopurs_runtime.Value {
	once_Main_functorMonoAndPro.Do(func() {
		cache_Main_functorMonoAndPro = gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer((&Constructor_Data_Functor_Functor[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(f_0 gopurs_runtime.Value, m_1 gopurs_runtime.Value) gopurs_runtime.Value {
			return m_1
		})}))}
	})
...
func Get_Main_functorTest3() gopurs_runtime.Value {
	once_Main_functorTest3.Do(func() {
		cache_Main_functorTest3 = gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer((&Constructor_Data_Functor_Functor[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(f_0 gopurs_runtime.Value, m_1 gopurs_runtime.Value) gopurs_runtime.Value {
			return m_1
		})}))}
	})
...
func Get_Main_functorMonoAndBi() gopurs_runtime.Value {
	once_Main_functorMonoAndBi.Do(func() {
		cache_Main_functorMonoAndBi = gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer((&Constructor_Data_Functor_Functor[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(f_0 gopurs_runtime.Value, m_1 gopurs_runtime.Value) gopurs_runtime.Value {
			return m_1
		})}))}
	})
...
func Get_Main_functorTest1() gopurs_runtime.Value {
	once_Main_functorTest1.Do(func() {
		cache_Main_functorTest1 = gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer((&Constructor_Data_Functor_Functor[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(f_0 gopurs_runtime.Value, m_1 gopurs_runtime.Value) gopurs_runtime.Value {
			return m_1
		})}))}
	})
...
func Get_Main_bifunctorMonoAndBi() gopurs_runtime.Value {
	once_Main_bifunctorMonoAndBi.Do(func() {
		cache_Main_bifunctorMonoAndBi = gopurs_runtime.Value{Type: 9, IntVal: 4141114362, UnsafePtr: unsafe.Pointer((&Constructor_Data_Bifunctor_Bifunctor[gopurs_runtime.Value]{1, gopurs_runtime.Func3(func(v_0 gopurs_runtime.Value, v1_1 gopurs_runtime.Value, v2_2 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Main_bifunctorExclusivelyBi() gopurs_runtime.Value {
	once_Main_bifunctorExclusivelyBi.Do(func() {
		cache_Main_bifunctorExclusivelyBi = gopurs_runtime.Value{Type: 9, IntVal: 4141114362, UnsafePtr: unsafe.Pointer((&Constructor_Data_Bifunctor_Bifunctor[gopurs_runtime.Value]{1, gopurs_runtime.Func3(func(f_0 gopurs_runtime.Value, g_1 gopurs_runtime.Value, m_2 gopurs_runtime.Value) gopurs_runtime.Value {
			return func() gopurs_runtime.Value { panic("Failed pattern match") }()
		})}))}
	})
...
func Get_Main_functorTest2() gopurs_runtime.Value {
	once_Main_functorTest2.Do(func() {
		cache_Main_functorTest2 = gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer((&Constructor_Data_Functor_Functor[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(f_0 gopurs_runtime.Value, m_1 gopurs_runtime.Value) gopurs_runtime.Value {
			return func() gopurs_runtime.Value { panic("Failed pattern match") }()
		})}))}
	})
