...
func Get_Main_main() gopurs_runtime.Value {
	once_Main_main.Do(func() {
		cache_Main_main = func() gopurs_runtime.Value {
			// TAST (Let): z_0_0 -> gopurs_runtime.Value
			...
			return gopurs_runtime.Func(func(_ gopurs_runtime.Value) gopurs_runtime.Value {
				...
				_dollar___unused_4_8 := gopurs_runtime.Apply(gopurs_runtime.Apply(Get_Effect_Console_log(), gopurs_runtime.Str(gopurs_runtime.Apply(Get_Data_Show_showIntImpl(), gopurs_runtime.Int(z_0_0.IntVal)).StrVal())), gopurs_runtime.Value{})
				...
				var __t14 gopurs_runtime.Value
				{
					...
					if (gopurs_runtime.Apply3(go__go_5_9_5, gopurs_runtime.Func(func(x_6 gopurs_runtime.Value) gopurs_runtime.Value {
						...
						__t_and_13 = ((gopurs_runtime.Apply3(go__go_6_11_6, gopurs_runtime.Func(func(x_7 gopurs_runtime.Value) gopurs_runtime.Value {
							return x_7
						}), gopurs_runtime.Int(7), gopurs_runtime.Int(3)).IntVal) == (10)) && ((z_0_0.IntVal) == (1))
					}
					if __t_and_13 {
