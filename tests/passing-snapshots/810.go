...
func Get_Main_test() gopurs_runtime.Value {
	once_Main_test.Do(func() {
		cache_Main_test = gopurs_runtime.Func(func(m_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Value{Type: 9, IntVal: 3271839782, UnsafePtr: unsafe.Pointer(Call_Main_test(gopurs_runtime.CoerceToStruct[Constructor_Main_Just[gopurs_runtime.Value]](m_0_box)))}
		})
	})
...
func Call_Main_test(m_0_loop *Constructor_Main_Just[gopurs_runtime.Value]) *Constructor_Main_Just[gopurs_runtime.Value] {
	var m_0 *Constructor_Main_Just[gopurs_runtime.Value] = m_0_loop
	_ = m_0
	...
	{
		if m_0 != nil {
			__t0 = (&Constructor_Main_Just[gopurs_runtime.Value]{1, (m_0).V0})
			goto end_branch_0
		} else {
