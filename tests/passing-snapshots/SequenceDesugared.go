...
func Get_Main_sequenceListSeq__2621562580() gopurs_runtime.Value {
	once_Main_sequenceListSeq__2621562580.Do(func() {
		cache_Main_sequenceListSeq__2621562580 = gopurs_runtime.Func(func(dictMonad_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_sequenceListSeq__2621562580(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Monad[gopurs_runtime.Value]](dictMonad_0_box))
		})
	})
	...
	once_Main_sequenceList_prime_.Do(func() {
		cache_Main_sequenceList_prime_ = gopurs_runtime.Func(func(dictMonad_0 gopurs_runtime.Value) gopurs_runtime.Value {
			...
			return gopurs_runtime.Func(func(val_5 gopurs_runtime.Value) gopurs_runtime.Value {
				...
				{
					if val_5.Type == 9 && val_5.IntVal == 322902991 && val_5.UnsafePtr != nil {
						__t4 = gopurs_runtime.Apply2(gopurs_runtime.Box(Apply0_3_2.V1), gopurs_runtime.Apply2(gopurs_runtime.Box(Functor0_4_3.V0), Get_Main_Cons(), (*Constructor_Main_Cons[gopurs_runtime.Value])(val_5.UnsafePtr).V0), gopurs_runtime.Apply2(Get_Main_sequenceList_prime_(), gopurs_runtime.Value{Type: 9, IntVal: 778916621, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Monad[gopurs_runtime.Value]](dictMonad_0))}, gopurs_runtime.Value{Type: 9, IntVal: 322902991, UnsafePtr: unsafe.Pointer((*Constructor_Main_Cons[gopurs_runtime.Value])(val_5.UnsafePtr).V1)}))
						goto end_branch_4
					} else {
	...
	once_Main_sequenceList_prime__prime__prime_.Do(func() {
		cache_Main_sequenceList_prime__prime__prime_ = gopurs_runtime.Func(func(dictMonad_0 gopurs_runtime.Value) gopurs_runtime.Value {
			...
			return gopurs_runtime.Func(func(val_5 gopurs_runtime.Value) gopurs_runtime.Value {
				...
				{
					if val_5.Type == 9 && val_5.IntVal == 322902991 && val_5.UnsafePtr != nil {
						__t4 = gopurs_runtime.Apply2(gopurs_runtime.Box(Apply0_3_2.V1), gopurs_runtime.Apply2(gopurs_runtime.Box(Functor0_4_3.V0), Get_Main_Cons(), (*Constructor_Main_Cons[gopurs_runtime.Value])(val_5.UnsafePtr).V0), gopurs_runtime.Apply2(Get_Main_sequenceList_prime__prime__prime_(), gopurs_runtime.Value{Type: 9, IntVal: 778916621, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Monad[gopurs_runtime.Value]](dictMonad_0))}, gopurs_runtime.Value{Type: 9, IntVal: 322902991, UnsafePtr: unsafe.Pointer((*Constructor_Main_Cons[gopurs_runtime.Value])(val_5.UnsafePtr).V1)}))
						goto end_branch_4
					} else {
...
func Get_Main_main() gopurs_runtime.Value {
	once_Main_main.Do(func() {
		cache_Main_main = gopurs_runtime.Func(func(_ gopurs_runtime.Value) gopurs_runtime.Value {
			// TAST (Let): __local_var_0_0 shape=App(Other) bindingType=(ADT ["Effect","Effect"] [(ADT ["Main","List"] [Unit])])
...
func Call_Main_sequenceListSeq__2621562580(dictMonad_0_loop *Constructor_Control_Monad_Monad[gopurs_runtime.Value]) gopurs_runtime.Value {
	var dictMonad_0 *Constructor_Control_Monad_Monad[gopurs_runtime.Value] = dictMonad_0_loop
	_ = dictMonad_0
	// TAST (Let): Applicative0_1_0 shape=App(Other) bindingType=(ADT ["Control","Applicative","Applicative"] [(TypeVar m)])
	Applicative0_1_0 := gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative[gopurs_runtime.Value]](gopurs_runtime.Apply(gopurs_runtime.Box(dictMonad_0.V0), gopurs_runtime.Value{}))
	...
	return gopurs_runtime.Func(func(v_5 gopurs_runtime.Value) gopurs_runtime.Value {
		...
		{
			if v_5.Type == 9 && v_5.IntVal == 322902991 && v_5.UnsafePtr == nil {
				__t11 = gopurs_runtime.Apply(gopurs_runtime.Box(Applicative0_1_0.V1), gopurs_runtime.Value{Type: 9, IntVal: 322902991, UnsafePtr: unsafe.Pointer((*Constructor_Main_Cons[gopurs_runtime.Value])(nil))})
				goto end_branch_11
			} else {
		...
		{
			if v_5.Type == 9 && v_5.IntVal == 322902991 && v_5.UnsafePtr != nil {
				// TAST (Let): Applicative0_6_4 shape=App(Other) bindingType=(ADT ["Control","Applicative","Applicative"] [(TypeVar m)])
				Applicative0_6_4 := gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative[gopurs_runtime.Value]](gopurs_runtime.Apply(gopurs_runtime.Box(dictMonad_0.V0), gopurs_runtime.Value{}))
				_ = Applicative0_6_4
				// TAST (Let): Bind1_7_5 shape=App(Other) bindingType=Any
				Bind1_7_5 := gopurs_runtime.Apply(gopurs_runtime.Box(dictMonad_0.V1), gopurs_runtime.Value{})
				_ = Bind1_7_5
				// TAST (Let): Apply0_8_6 shape=App(Other) bindingType=(ADT ["Control","Apply","Apply"] [(TypeVar m)])
				Apply0_8_6 := gopurs_runtime.CoerceToStruct[Constructor_Control_Apply_Apply[gopurs_runtime.Value]](gopurs_runtime.Apply(gopurs_runtime.RecordGet(Bind1_7_5, "Apply0"), gopurs_runtime.Value{}))
				_ = Apply0_8_6
				// TAST (Let): Functor0_9_7 shape=App(Other) bindingType=(ADT ["Data","Functor","Functor"] [(TypeVar m)])
				Functor0_9_7 := gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor[gopurs_runtime.Value]](gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(Bind1_7_5, "Apply0"), gopurs_runtime.Value{}), "Functor0"), gopurs_runtime.Value{}))
				_ = Functor0_9_7
				var __t10 gopurs_runtime.Value
				{
					var __t_tag_8 *Constructor_Main_Cons[gopurs_runtime.Value] = (*Constructor_Main_Cons[gopurs_runtime.Value])(v_5.UnsafePtr).V1
					if __t_tag_8 == nil {
						__t10 = gopurs_runtime.Apply(gopurs_runtime.Box(Applicative0_6_4.V1), gopurs_runtime.Value{Type: 9, IntVal: 322902991, UnsafePtr: unsafe.Pointer((*Constructor_Main_Cons[gopurs_runtime.Value])(nil))})
						goto end_branch_10
					} else {
				...
				{
					var __t_tag_9 *Constructor_Main_Cons[gopurs_runtime.Value] = (*Constructor_Main_Cons[gopurs_runtime.Value])(v_5.UnsafePtr).V1
					if __t_tag_9 != nil {
						__t10 = gopurs_runtime.Apply2(gopurs_runtime.Box(Apply0_8_6.V1), gopurs_runtime.Apply2(gopurs_runtime.Box(Functor0_9_7.V0), Get_Main_Cons(), ((*Constructor_Main_Cons[gopurs_runtime.Value])(v_5.UnsafePtr).V1).V0), gopurs_runtime.Apply(Call_Main_sequenceListSeq(dictMonad_0), gopurs_runtime.Value{Type: 9, IntVal: 322902991, UnsafePtr: unsafe.Pointer(((*Constructor_Main_Cons[gopurs_runtime.Value])(v_5.UnsafePtr).V1).V1)}))
						goto end_branch_10
					} else {
			...
			end_branch_10:
				__t11 = gopurs_runtime.Apply2(gopurs_runtime.Box(Apply0_3_2.V1), gopurs_runtime.Apply2(gopurs_runtime.Box(Functor0_4_3.V0), Get_Main_Cons(), (*Constructor_Main_Cons[gopurs_runtime.Value])(v_5.UnsafePtr).V0), __t10)
				goto end_branch_11
			} else {
