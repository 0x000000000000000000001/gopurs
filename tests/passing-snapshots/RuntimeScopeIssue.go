...
func Get_Main_b__9469573() gopurs_runtime.Value {
	once_Main_b__9469573.Do(func() {
		cache_Main_b__9469573 = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_b__9469573(gopurs_runtime.CoerceToStruct[Constructor_Main_B[gopurs_runtime.Value]](dict_0_box))
		})
	})
...
func Get_Main_a__1664477318() gopurs_runtime.Value {
	once_Main_a__1664477318.Do(func() {
		cache_Main_a__1664477318 = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_a__1664477318(gopurs_runtime.CoerceToStruct[Constructor_Main_A[gopurs_runtime.Value]](dict_0_box))
		})
	})
...
func Get_Main_bNumber() gopurs_runtime.Value {
	once_Main_bNumber.Do(func() {
		cache_Main_bNumber = gopurs_runtime.Value{Type: 9, IntVal: 4250879068, UnsafePtr: unsafe.Pointer((&Constructor_Main_B[float64]{1, gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
			var __t0 bool
			{
				if (v_0.FloatVal()) == (0.0) {
					__t0 = false
			...
			{
				__t0 = (gopurs_runtime.Apply(gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Main_A[float64]](Get_Main_aNumber()).V0), gopurs_runtime.Float((v_0.FloatVal())-(1.0))).IntVal) != (0)
			}
		end_branch_0:
...
func Get_Main_aNumber() gopurs_runtime.Value {
	once_Main_aNumber.Do(func() {
		cache_Main_aNumber = gopurs_runtime.Value{Type: 9, IntVal: 4219254943, UnsafePtr: unsafe.Pointer((&Constructor_Main_A[float64]{1, gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
			var __t2 bool
			{
				if (v_0.FloatVal()) == (0.0) {
					__t2 = true
			...
			{
				// TAST (Let): __local_var_1_0 shape=Other bindingType=Number
				...
				{
					__t1 = (gopurs_runtime.Apply(gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Main_A[float64]](Get_Main_aNumber()).V0), gopurs_runtime.Float((__local_var_1_0)-(1.0))).IntVal) != (0)
				}
			end_branch_1:
				__t2 = __t1
			}
...
func Get_Main_main() gopurs_runtime.Value {
	once_Main_main.Do(func() {
		cache_Main_main = gopurs_runtime.Func(func(_ gopurs_runtime.Value) gopurs_runtime.Value {
			var __t1 string
			{
				if (gopurs_runtime.Bool((gopurs_runtime.Apply(gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Main_A[float64]](Get_Main_aNumber()).V0), gopurs_runtime.Float(8.0)).IntVal) != (0)).IntVal) != (0) {
					__t1 = "true"
					goto end_branch_1
				} else {
...
func Call_Main_b__9469573(dict_0_loop *Constructor_Main_B[gopurs_runtime.Value]) gopurs_runtime.Value {
	var dict_0 *Constructor_Main_B[gopurs_runtime.Value] = dict_0_loop
	_ = dict_0
	return gopurs_runtime.Box(dict_0.V0)
}
...
func Call_Main_a__1664477318(dict_0_loop *Constructor_Main_A[gopurs_runtime.Value]) gopurs_runtime.Value {
	var dict_0 *Constructor_Main_A[gopurs_runtime.Value] = dict_0_loop
	_ = dict_0
	return gopurs_runtime.Box(dict_0.V0)
}
