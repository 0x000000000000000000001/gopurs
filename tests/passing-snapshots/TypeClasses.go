...
func Get_Main_pure() gopurs_runtime.Value {
	once_Main_pure.Do(func() {
		cache_Main_pure = gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative[gopurs_runtime.Value]](Get_Control_Applicative_applicativeFn()).V1)
	})
...
func Get_Main_test7__2742601362() gopurs_runtime.Value {
	once_Main_test7__2742601362.Do(func() {
		cache_Main_test7__2742601362 = gopurs_runtime.Func(func(dictShow_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_test7__2742601362(gopurs_runtime.CoerceToStruct[Constructor_Data_Show_Show[gopurs_runtime.Value]](dictShow_0_box))
		})
	})
...
func Get_Main_showData1() gopurs_runtime.Value {
	once_Main_showData1.Do(func() {
		cache_Main_showData1 = gopurs_runtime.Value{Type: 9, IntVal: 1835580986, UnsafePtr: unsafe.Pointer((&Constructor_Data_Show_Show[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
var cache_Main_f__1496134642 gopurs_runtime.Value
var once_Main_f__1496134642 sync.Once

func Get_Main_f__1496134642() gopurs_runtime.Value {
	once_Main_f__1496134642.Do(func() {
		cache_Main_f__1496134642 = gopurs_runtime.Func2(func(dictShow_0_box gopurs_runtime.Value, x_1_box gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Str(Call_Main_f__1496134642(gopurs_runtime.CoerceToStruct[Constructor_Data_Show_Show[gopurs_runtime.Value]](dictShow_0_box), x_1_box))
		})
	})
	return cache_Main_f__1496134642
}
...
func Get_Main_f__2742601362() gopurs_runtime.Value {
	once_Main_f__2742601362.Do(func() {
		cache_Main_f__2742601362 = gopurs_runtime.Func2(func(dictShow_0_box gopurs_runtime.Value, x_1_box gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Str(Call_Main_f__2742601362(gopurs_runtime.CoerceToStruct[Constructor_Data_Show_Show[gopurs_runtime.Value]](dictShow_0_box), x_1_box))
		})
	})
...
func Get_Main_monadMaybe() gopurs_runtime.Value {
	once_Main_monadMaybe.Do(func() {
		cache_Main_monadMaybe = gopurs_runtime.Value{Type: 9, IntVal: 778916621, UnsafePtr: unsafe.Pointer((&Constructor_Control_Monad_Monad[*Constructor_Main_Just[gopurs_runtime.Value]]{1, gopurs_runtime.Func(func(_dollar___unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Value{Type: 9, IntVal: 1459134221, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative[*Constructor_Main_Just[gopurs_runtime.Value]]](Get_Main_applicativeMaybe()))}
		}), gopurs_runtime.Func(func(_dollar___unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Value{Type: 9, IntVal: 4032919565, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Bind_Bind[*Constructor_Main_Just[gopurs_runtime.Value]]](Get_Main_bindMaybe()))}
		})}))}
	})
...
func Get_Main_functorMaybe() gopurs_runtime.Value {
	once_Main_functorMaybe.Do(func() {
		cache_Main_functorMaybe = gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer((&Constructor_Data_Functor_Functor[*Constructor_Main_Just[gopurs_runtime.Value]]{1, gopurs_runtime.Func(func(f_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Func(func(a_1 gopurs_runtime.Value) gopurs_runtime.Value {
				return gopurs_runtime.Apply2(gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Control_Bind_Bind[*Constructor_Main_Just[gopurs_runtime.Value]]](Get_Main_bindMaybe()).V1), a_1, gopurs_runtime.Func(func(a_prime__2 gopurs_runtime.Value) gopurs_runtime.Value {
					return gopurs_runtime.Apply(gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative[*Constructor_Main_Just[gopurs_runtime.Value]]](Get_Main_applicativeMaybe()).V1), gopurs_runtime.Apply(f_0, a_prime__2))
				}))
			})
		})}))}
	})
...
func Get_Main_bindMaybe() gopurs_runtime.Value {
	once_Main_bindMaybe.Do(func() {
		cache_Main_bindMaybe = gopurs_runtime.Value{Type: 9, IntVal: 4032919565, UnsafePtr: unsafe.Pointer((&Constructor_Control_Bind_Bind[*Constructor_Main_Just[gopurs_runtime.Value]]{1, gopurs_runtime.Func(func(_dollar___unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Value{Type: 9, IntVal: 3032403085, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Apply_Apply[*Constructor_Main_Just[gopurs_runtime.Value]]](Get_Main_applyMaybe()))}
...
func Get_Main_applyMaybe() gopurs_runtime.Value {
	once_Main_applyMaybe.Do(func() {
		cache_Main_applyMaybe = gopurs_runtime.Value{Type: 9, IntVal: 3032403085, UnsafePtr: unsafe.Pointer((&Constructor_Control_Apply_Apply[*Constructor_Main_Just[gopurs_runtime.Value]]{1, gopurs_runtime.Func(func(_dollar___unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor[*Constructor_Main_Just[gopurs_runtime.Value]]](Get_Main_functorMaybe()))}
			...
			return gopurs_runtime.Func(func(a_1 gopurs_runtime.Value) gopurs_runtime.Value {
				...
				}
				{
					if f_0.Type == 9 && f_0.IntVal == 3271839782 && f_0.UnsafePtr != nil {
						...
						{
							if a_1.Type == 9 && a_1.IntVal == 3271839782 && a_1.UnsafePtr != nil {
								__t0 = gopurs_runtime.CoerceToStruct[Constructor_Main_Just[gopurs_runtime.Value]](gopurs_runtime.Apply(gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative[*Constructor_Main_Just[gopurs_runtime.Value]]](Get_Main_applicativeMaybe()).V1), gopurs_runtime.Apply((*Constructor_Main_Just[gopurs_runtime.Value])(f_0.UnsafePtr).V0, (*Constructor_Main_Just[gopurs_runtime.Value])(a_1.UnsafePtr).V0)))
								goto end_branch_0
							} else {
				...
				{
					__t1 = gopurs_runtime.CoerceToStruct[Constructor_Main_Just[gopurs_runtime.Value]](func() gopurs_runtime.Value { panic("Failed pattern match") }())
				}
			end_branch_1:
...
func Get_Main_applicativeMaybe() gopurs_runtime.Value {
	once_Main_applicativeMaybe.Do(func() {
		cache_Main_applicativeMaybe = gopurs_runtime.Value{Type: 9, IntVal: 1459134221, UnsafePtr: unsafe.Pointer((&Constructor_Control_Applicative_Applicative[*Constructor_Main_Just[gopurs_runtime.Value]]{1, gopurs_runtime.Func(func(_dollar___unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Value{Type: 9, IntVal: 3032403085, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Apply_Apply[*Constructor_Main_Just[gopurs_runtime.Value]]](Get_Main_applyMaybe()))}
		}), Get_Main_Just()}))}
	})
...
func Get_Main_functorData() gopurs_runtime.Value {
	once_Main_functorData.Do(func() {
		cache_Main_functorData = gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer((&Constructor_Data_Functor_Functor[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(f_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Func(func(a_1 gopurs_runtime.Value) gopurs_runtime.Value {
				return gopurs_runtime.Apply2(gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Control_Bind_Bind[gopurs_runtime.Value]](Get_Main_bindData()).V1), a_1, gopurs_runtime.Func(func(a_prime__2 gopurs_runtime.Value) gopurs_runtime.Value {
					return gopurs_runtime.Apply(gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative[gopurs_runtime.Value]](Get_Main_applicativeData()).V1), gopurs_runtime.Apply(f_0, a_prime__2))
				}))
			})
		})}))}
	})
...
func Get_Main_applyData() gopurs_runtime.Value {
	once_Main_applyData.Do(func() {
		cache_Main_applyData = gopurs_runtime.Value{Type: 9, IntVal: 3032403085, UnsafePtr: unsafe.Pointer((&Constructor_Control_Apply_Apply[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(_dollar___unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
			...
			return gopurs_runtime.Func(func(a_1 gopurs_runtime.Value) gopurs_runtime.Value {
				return gopurs_runtime.Apply(gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative[gopurs_runtime.Value]](Get_Main_applicativeData()).V1), gopurs_runtime.Apply(f_0, a_1))
			})
		})}))}
	})
...
func Call_Main_test7__2742601362(dictShow_0_loop *Constructor_Data_Show_Show[gopurs_runtime.Value]) gopurs_runtime.Value {
	var dictShow_0 *Constructor_Data_Show_Show[gopurs_runtime.Value] = dictShow_0_loop
	_ = dictShow_0
	return gopurs_runtime.Box(dictShow_0.V0)
}
...
func Call_Main_f__1496134642(dictShow_0_loop *Constructor_Data_Show_Show[gopurs_runtime.Value], x_1_loop gopurs_runtime.Value) string {
	var dictShow_0 *Constructor_Data_Show_Show[gopurs_runtime.Value] = dictShow_0_loop
	_ = dictShow_0
	var x_1 gopurs_runtime.Value = x_1_loop
	_ = x_1
...
func Call_Main_f__2742601362(dictShow_0_loop *Constructor_Data_Show_Show[gopurs_runtime.Value], x_1_loop gopurs_runtime.Value) string {
	var dictShow_0 *Constructor_Data_Show_Show[gopurs_runtime.Value] = dictShow_0_loop
	_ = dictShow_0
	var x_1 gopurs_runtime.Value = x_1_loop
	_ = x_1
...
func Call_Main_test5(v_0_loop gopurs_runtime.Value) *Constructor_Main_Just[float64] {
	var v_0 gopurs_runtime.Value = v_0_loop
	_ = v_0
	return gopurs_runtime.CoerceToStruct[Constructor_Main_Just[float64]](gopurs_runtime.Value{Type: 9, IntVal: 3271839782, UnsafePtr: unsafe.Pointer((&Constructor_Main_Just[gopurs_runtime.Value]{1, gopurs_runtime.Float(2.0)}))})
}
