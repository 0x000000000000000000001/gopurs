...
func Get_Main_append() gopurs_runtime.Value {
	once_Main_append.Do(func() {
		cache_Main_append = gopurs_runtime.Func4(func(l1_0_box gopurs_runtime.Value, l2_1_box gopurs_runtime.Value, r_2_box gopurs_runtime.Value, f_3_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_append(l1_0_box, l2_1_box, r_2_box, f_3_box)
		})
	})
...
func Call_Main_append(l1_0_loop gopurs_runtime.Value, l2_1_loop gopurs_runtime.Value, r_2_loop gopurs_runtime.Value, f_3_loop gopurs_runtime.Value) gopurs_runtime.Value {
