...
func Call_Main_test(r_0_loop gopurs_runtime.Value, f_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
	...
	var f_1 gopurs_runtime.Value = f_1_loop
	_ = f_1
	return gopurs_runtime.Apply2(gopurs_runtime.Func2(func(r_2 gopurs_runtime.Value, f_3 gopurs_runtime.Value) gopurs_runtime.Value {
		return gopurs_runtime.Apply2(f_3, gopurs_runtime.Int(int64(2)), Call_Main_empty(r_2, f_3))
	}), gopurs_runtime.Apply2(gopurs_runtime.Func2(func(r_2 gopurs_runtime.Value, f_3 gopurs_runtime.Value) gopurs_runtime.Value {
		return gopurs_runtime.Apply2(f_3, gopurs_runtime.Int(int64(1)), Call_Main_empty(r_2, f_3))
	}), r_0, f_1), f_1)
}
