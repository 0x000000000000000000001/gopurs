...
func Get_Main_cons() gopurs_runtime.Value {
	once_Main_cons.Do(func() {
		cache_Main_cons = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_cons(gopurs_runtime.CoerceToStruct[Constructor_Main_Cons](dict_0_box))
		})
	})
...
func Call_Main_cons(dict_0_loop *Constructor_Main_Cons) gopurs_runtime.Value {
	var dict_0 *Constructor_Main_Cons = dict_0_loop
	_ = dict_0
