...
func Get_Main_main() gopurs_runtime.Value {
	once_Main_main.Do(func() {
		cache_Main_main = func() gopurs_runtime.Value {
			var Call_local_Main_to_0_0_0 func(gopurs_runtime.Value, *Constructor_Main_More) gopurs_runtime.Value
			_ = Call_local_Main_to_0_0_0
			var to_0_0_0 gopurs_runtime.Value
			_ = to_0_0_0
			Call_local_Main_to_0_0_0 = func(v_1_loop gopurs_runtime.Value, v1_2_loop *Constructor_Main_More) gopurs_runtime.Value {
			to_0_0_0:
				for {
					if false {
						continue to_0_0_0
			...
			to_0_0_0 = gopurs_runtime.Func(func(v_1_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
				return gopurs_runtime.Func(func(v1_2_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
					return Call_local_Main_to_0_0_0(v_1_loop_val, gopurs_runtime.CoerceToStruct[Constructor_Main_More](v1_2_loop_val))
				})
			})
			var Call_local_Main_from_1_2_1 func(gopurs_runtime.Value) gopurs_runtime.Value
			_ = Call_local_Main_from_1_2_1
			var from_1_2_1 gopurs_runtime.Value
			_ = from_1_2_1
			Call_local_Main_from_1_2_1 = func(v_2_loop gopurs_runtime.Value) gopurs_runtime.Value {
			from_1_2_1:
				for {
					if false {
						continue from_1_2_1
			...
			from_1_2_1 = gopurs_runtime.Func(func(v_2_loop_val gopurs_runtime.Value) gopurs_runtime.Value {
				return Call_local_Main_from_1_2_1(v_2_loop_val)
			})
			return gopurs_runtime.Apply(Get_Effect_Console_log(), gopurs_runtime.Str(Call_local_Main_from_1_2_1(gopurs_runtime.Value{Type: 9, IntVal: 2472542475, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Main_More](Call_local_Main_to_0_0_0(gopurs_runtime.Float(10000.0), (*Constructor_Main_More)(nil))))}).StrVal()))
		}()
	})
