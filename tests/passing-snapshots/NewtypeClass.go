...
func Get_Main_wrap() gopurs_runtime.Value {
	once_Main_wrap.Do(func() {
		cache_Main_wrap = gopurs_runtime.Func(func(_dollar___unused_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_wrap(gopurs_runtime.CoerceToStruct[Constructor_Main_Newtype](_dollar___unused_0_box))
		})
	})
...
func Get_Main_unwrap() gopurs_runtime.Value {
	once_Main_unwrap.Do(func() {
		cache_Main_unwrap = gopurs_runtime.Func(func(_dollar___unused_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_unwrap(gopurs_runtime.CoerceToStruct[Constructor_Main_Newtype](_dollar___unused_0_box))
		})
	})
...
func Get_Main_newtypeMultiplicative() gopurs_runtime.Value {
	once_Main_newtypeMultiplicative.Do(func() {
		cache_Main_newtypeMultiplicative = gopurs_runtime.Value{Type: 9, IntVal: 1443761658, UnsafePtr: unsafe.Pointer((&Constructor_Main_Newtype{1, gopurs_runtime.Func(func(_dollar___unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Main_foldPair() gopurs_runtime.Value {
	once_Main_foldPair.Do(func() {
		cache_Main_foldPair = gopurs_runtime.Func3(func(dictSemigroup_0_box gopurs_runtime.Value, f_1_box gopurs_runtime.Value, v_2_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_foldPair(gopurs_runtime.CoerceToStruct[Constructor_Data_Semigroup_Semigroup](dictSemigroup_0_box), f_1_box, gopurs_runtime.CoerceToStruct[Constructor_Main_Pair](v_2_box))
		})
	})
...
func Get_Main_ala() gopurs_runtime.Value {
	once_Main_ala.Do(func() {
		cache_Main_ala = gopurs_runtime.Func4(func(dictFunctor_0_box gopurs_runtime.Value, _dollar___unused_1_box gopurs_runtime.Value, v_2_box gopurs_runtime.Value, f_3_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_ala(gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor](dictFunctor_0_box), gopurs_runtime.CoerceToStruct[Constructor_Main_Newtype](_dollar___unused_1_box), v_2_box, f_3_box)
		})
	})
...
func Get_Main_ala__162501229() gopurs_runtime.Value {
	once_Main_ala__162501229.Do(func() {
		cache_Main_ala__162501229 = gopurs_runtime.Func4(func(dictFunctor_0_box gopurs_runtime.Value, _dollar___unused_1_box gopurs_runtime.Value, v_2_box gopurs_runtime.Value, f_3_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_ala__162501229(gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor](dictFunctor_0_box), gopurs_runtime.CoerceToStruct[Constructor_Main_Newtype](_dollar___unused_1_box), v_2_box, f_3_box)
		})
	})
...
type Constructor_Main_Newtype struct {
	Rc uint32
	V0 gopurs_runtime.Value
}
...
func init() {
	gopurs_runtime.StructGetters[1443761658] = func(ptr unsafe.Pointer, key string) gopurs_runtime.Value {
		c := (*Constructor_Main_Newtype)(ptr)
		_ = c
		switch key {
		case "Coercible0":
...
func Call_Main_wrap(_dollar___unused_0_loop *Constructor_Main_Newtype) gopurs_runtime.Value {
	var _dollar___unused_0 *Constructor_Main_Newtype = _dollar___unused_0_loop
	_ = _dollar___unused_0
	return Get_Unsafe_Coerce_unsafeCoerce()
}

func Call_Main_unwrap(_dollar___unused_0_loop *Constructor_Main_Newtype) gopurs_runtime.Value {
	var _dollar___unused_0 *Constructor_Main_Newtype = _dollar___unused_0_loop
	_ = _dollar___unused_0
	return Get_Unsafe_Coerce_unsafeCoerce()
}
...
func Call_Main_foldPair(dictSemigroup_0_loop *Constructor_Data_Semigroup_Semigroup, f_1_loop gopurs_runtime.Value, v_2_loop *Constructor_Main_Pair) gopurs_runtime.Value {
	var dictSemigroup_0 *Constructor_Data_Semigroup_Semigroup = dictSemigroup_0_loop
	_ = dictSemigroup_0
	var f_1 gopurs_runtime.Value = f_1_loop
	_ = f_1
	var v_2 *Constructor_Main_Pair = v_2_loop
	_ = v_2
...
func Call_Main_ala(dictFunctor_0_loop *Constructor_Data_Functor_Functor, _dollar___unused_1_loop *Constructor_Main_Newtype, v_2_loop gopurs_runtime.Value, f_3_loop gopurs_runtime.Value) gopurs_runtime.Value {
	var dictFunctor_0 *Constructor_Data_Functor_Functor = dictFunctor_0_loop
	_ = dictFunctor_0
	var _dollar___unused_1 *Constructor_Main_Newtype = _dollar___unused_1_loop
...
func Call_Main_test(dictSemiring_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
	...
	return gopurs_runtime.Func(func(x_2 gopurs_runtime.Value) gopurs_runtime.Value {
		return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_1_0, "append"), (*Constructor_Main_Pair)(x_2.UnsafePtr).V0, (*Constructor_Main_Pair)(x_2.UnsafePtr).V1)
	})
}

func Call_Main_ala__162501229(dictFunctor_0_loop *Constructor_Data_Functor_Functor, _dollar___unused_1_loop *Constructor_Main_Newtype, v_2_loop gopurs_runtime.Value, f_3_loop gopurs_runtime.Value) gopurs_runtime.Value {
	var dictFunctor_0 *Constructor_Data_Functor_Functor = dictFunctor_0_loop
	_ = dictFunctor_0
	var _dollar___unused_1 *Constructor_Main_Newtype = _dollar___unused_1_loop
	_ = _dollar___unused_1
