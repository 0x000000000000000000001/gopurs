...
func Get_Main_uncons__3027971297() gopurs_runtime.Value {
	once_Main_uncons__3027971297.Do(func() {
		cache_Main_uncons__3027971297 = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_uncons__3027971297(gopurs_runtime.CoerceToStruct[Constructor_Main_IsStream[gopurs_runtime.Value, gopurs_runtime.Value]](dict_0_box))
		})
	})
...
func Get_Main_streamIsStream() gopurs_runtime.Value {
	once_Main_streamIsStream.Do(func() {
		cache_Main_streamIsStream = gopurs_runtime.Value{Type: 9, IntVal: 668736856, UnsafePtr: unsafe.Pointer((&Constructor_Main_IsStream[gopurs_runtime.Value, *Constructor_Main_Stream[gopurs_runtime.Value]]{1, gopurs_runtime.Func(func(x_0 gopurs_runtime.Value) gopurs_runtime.Value {
			...
			return gopurs_runtime.RecordDict2("head", "tail", (*Constructor_Main_Stream[gopurs_runtime.Value])(v_0.UnsafePtr).V0, gopurs_runtime.Value{Type: 9, IntVal: 1020906690, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Main_Stream[gopurs_runtime.Value]](gopurs_runtime.Apply((*Constructor_Main_Stream[gopurs_runtime.Value])(v_0.UnsafePtr).V1, Get_Data_Unit_unit())))})
		})}))}
	})
...
func Get_Main_streamIsStream__1249510304() gopurs_runtime.Value {
	once_Main_streamIsStream__1249510304.Do(func() {
		cache_Main_streamIsStream__1249510304 = gopurs_runtime.Value{Type: 9, IntVal: 668736856, UnsafePtr: unsafe.Pointer((&Constructor_Main_IsStream[gopurs_runtime.Value, *Constructor_Main_Stream[gopurs_runtime.Value]]{1, gopurs_runtime.Func(func(x_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Func(func(xs_1 gopurs_runtime.Value) gopurs_runtime.Value {
				return gopurs_runtime.Value{Type: 9, IntVal: 1020906690, UnsafePtr: unsafe.Pointer((&Constructor_Main_Stream[gopurs_runtime.Value]{1, x_0, xs_1}))}
			})
		}), gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Main_streamIsStream__3175905987() gopurs_runtime.Value {
	once_Main_streamIsStream__3175905987.Do(func() {
		cache_Main_streamIsStream__3175905987 = gopurs_runtime.Value{Type: 9, IntVal: 668736856, UnsafePtr: unsafe.Pointer((&Constructor_Main_IsStream[gopurs_runtime.Value, *Constructor_Main_Stream[gopurs_runtime.Value]]{1, gopurs_runtime.Func(func(x_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Func(func(xs_1 gopurs_runtime.Value) gopurs_runtime.Value {
				return gopurs_runtime.Value{Type: 9, IntVal: 1020906690, UnsafePtr: unsafe.Pointer((&Constructor_Main_Stream[gopurs_runtime.Value]{1, x_0, xs_1}))}
			})
		}), gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Main_cons__3099608975() gopurs_runtime.Value {
	once_Main_cons__3099608975.Do(func() {
		cache_Main_cons__3099608975 = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_cons__3099608975(gopurs_runtime.CoerceToStruct[Constructor_Main_IsStream[gopurs_runtime.Value, gopurs_runtime.Value]](dict_0_box))
		})
	})
...
func Get_Main_test__2939414718() gopurs_runtime.Value {
	once_Main_test__2939414718.Do(func() {
		cache_Main_test__2939414718 = gopurs_runtime.Func2(func(dictIsStream_0_box gopurs_runtime.Value, s_1_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_test__2939414718(gopurs_runtime.CoerceToStruct[Constructor_Main_IsStream[gopurs_runtime.Value, gopurs_runtime.Value]](dictIsStream_0_box), s_1_box)
		})
	})
...
func Get_Main_main() gopurs_runtime.Value {
	once_Main_main.Do(func() {
		cache_Main_main = func() gopurs_runtime.Value {
			...
			_ = dones_0_0_0
			dones_0_0_0 = gopurs_runtime.CoerceToStruct[Constructor_Main_Stream[string]](gopurs_runtime.Value{Type: 9, IntVal: 1020906690, UnsafePtr: unsafe.Pointer((&Constructor_Main_Stream[gopurs_runtime.Value]{1, gopurs_runtime.Str("Done"), gopurs_runtime.Func(func(v_1 gopurs_runtime.Value) gopurs_runtime.Value {
...
func init() {
	gopurs_runtime.StructGetters[668736856] = func(ptr unsafe.Pointer, key string) gopurs_runtime.Value {
		c := (*Constructor_Main_IsStream[any, any])(ptr)
		_ = c
		switch key {
		case "cons":
...
func Call_Main_uncons__3027971297(dict_0_loop *Constructor_Main_IsStream[gopurs_runtime.Value, gopurs_runtime.Value]) gopurs_runtime.Value {
	var dict_0 *Constructor_Main_IsStream[gopurs_runtime.Value, gopurs_runtime.Value] = dict_0_loop
	_ = dict_0
	return gopurs_runtime.Box(dict_0.V1)
}
...
func Call_Main_cons__3099608975(dict_0_loop *Constructor_Main_IsStream[gopurs_runtime.Value, gopurs_runtime.Value]) gopurs_runtime.Value {
	var dict_0 *Constructor_Main_IsStream[gopurs_runtime.Value, gopurs_runtime.Value] = dict_0_loop
	_ = dict_0
	return gopurs_runtime.Box(dict_0.V0)
}
...
func Call_Main_test(dictIsStream_0_loop *Constructor_Main_IsStream[gopurs_runtime.Value, gopurs_runtime.Value], s_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
	...
	_ = s_1
	// TAST (Let): v_2_0 shape=App(Other) bindingType=Any
...
func Call_Main_test__2939414718(dictIsStream_0_loop *Constructor_Main_IsStream[gopurs_runtime.Value, gopurs_runtime.Value], s_1_loop gopurs_runtime.Value) gopurs_runtime.Value {
	var dictIsStream_0 *Constructor_Main_IsStream[gopurs_runtime.Value, gopurs_runtime.Value] = dictIsStream_0_loop
	_ = dictIsStream_0
	var s_1 gopurs_runtime.Value = s_1_loop
	_ = s_1
