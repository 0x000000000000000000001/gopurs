...
func Get_Main_match2() gopurs_runtime.Value {
	once_Main_match2.Do(func() {
		cache_Main_match2 = gopurs_runtime.Func(func(v_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Float(Call_Main_match2(gopurs_runtime.CoerceToStruct[Constructor_Main_Cons[float64]](v_0_box)))
		})
	})
...
func Get_Main_main() gopurs_runtime.Value {
	once_Main_main.Do(func() {
		cache_Main_main = gopurs_runtime.Func(func(_ gopurs_runtime.Value) gopurs_runtime.Value {
			...
			__local_var_0_0 := gopurs_runtime.Apply2(Get_Test_Assert_assertImpl(), gopurs_runtime.Str("Incorrect result!"), gopurs_runtime.Bool((Call_Main_match2((&Constructor_Main_Cons[float64]{1, gopurs_runtime.Float(1.0), (&Constructor_Main_Cons[gopurs_runtime.Value]{1, gopurs_runtime.Float(2.0), (&Constructor_Main_Cons[gopurs_runtime.Value]{1, gopurs_runtime.Float(3.0), (&Constructor_Main_Cons[gopurs_runtime.Value]{1, gopurs_runtime.Float(4.0), (&Constructor_Main_Cons[gopurs_runtime.Value]{1, gopurs_runtime.Float(5.0), (&Constructor_Main_Cons[gopurs_runtime.Value]{1, gopurs_runtime.Float(6.0), (&Constructor_Main_Cons[gopurs_runtime.Value]{1, gopurs_runtime.Float(7.0), (&Constructor_Main_Cons[gopurs_runtime.Value]{1, gopurs_runtime.Float(8.0), (&Constructor_Main_Cons[gopurs_runtime.Value]{1, gopurs_runtime.Float(9.0), (*Constructor_Main_Cons[gopurs_runtime.Value])(nil)})})})})})})})})}))) == (100.0)))
			_ = __local_var_0_0
	...
	for {
		...
		var __t2 float64
		{
			...
			if v_0 != nil {
				...
				var __t_tag_0 *Constructor_Main_Cons[gopurs_runtime.Value] = (v_0).V1
				__t_and_1 = (__t_tag_0 != nil)
			}
			if __t_and_1 {
				__t2 = (((v_0).V0.FloatVal()) * (((v_0).V1).V0.FloatVal())) + (Call_Main_match2(gopurs_runtime.CoerceToStruct[Constructor_Main_Cons[float64]](gopurs_runtime.Value{Type: 9, IntVal: 322902991, UnsafePtr: unsafe.Pointer(((v_0).V1).V1)})))
				goto end_branch_2
			} else {
