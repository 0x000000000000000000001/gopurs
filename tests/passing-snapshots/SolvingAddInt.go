...
var cache_Main_c_prime_ gopurs_runtime.Value
var once_Main_c_prime_ sync.Once
...
func Get_Main_b() gopurs_runtime.Value {
	once_Main_b.Do(func() {
		cache_Main_b = gopurs_runtime.Func(func(_dollar___unused_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_b(_dollar___unused_0_box)
		})
	})
	return cache_Main_b
}

var cache_Main_b_prime_ gopurs_runtime.Value
var once_Main_b_prime_ sync.Once
...
func Call_Main_b(_dollar___unused_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
	var _dollar___unused_0 gopurs_runtime.Value = _dollar___unused_0_loop
	_ = _dollar___unused_0
	return gopurs_runtime.Value{Type: 9, IntVal: int64(227768594), UnsafePtr: nil}
}
