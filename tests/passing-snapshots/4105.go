...
func Get_Main_eqUpdateDto() gopurs_runtime.Value {
	once_Main_eqUpdateDto.Do(func() {
		cache_Main_eqUpdateDto = gopurs_runtime.Value{Type: 9, IntVal: 1012063514, UnsafePtr: unsafe.Pointer((&Constructor_Data_Eq_Eq[gopurs_runtime.Value]{1, gopurs_runtime.Func2(func(x_0 gopurs_runtime.Value, y_1 gopurs_runtime.Value) gopurs_runtime.Value {
