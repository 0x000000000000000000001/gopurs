...
func Get_Main_testFunctor() gopurs_runtime.Value {
	once_Main_testFunctor.Do(func() {
		cache_Main_testFunctor = gopurs_runtime.Func(func(dictMonad_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_testFunctor(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Monad](dictMonad_0_box))
		})
	})
...
func Get_Main_test() gopurs_runtime.Value {
	once_Main_test.Do(func() {
		cache_Main_test = gopurs_runtime.Func(func(dictMonad_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_test(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Monad](dictMonad_0_box))
		})
	})
...
func Get_Main_monadMTrace() gopurs_runtime.Value {
	once_Main_monadMTrace.Do(func() {
		cache_Main_monadMTrace = gopurs_runtime.Value{Type: 9, IntVal: 778916621, UnsafePtr: unsafe.Pointer((&Constructor_Control_Monad_Monad{1, gopurs_runtime.Func(func(_dollar___unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Value{Type: 9, IntVal: 1459134221, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative](Get_Main_applicativeMTrace()))}
		}), gopurs_runtime.Func(func(_dollar___unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Value{Type: 9, IntVal: 4032919565, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Bind_Bind](Get_Main_bindMTrace()))}
		})}))}
	})
...
func Get_Main_functorMTrace() gopurs_runtime.Value {
	once_Main_functorMTrace.Do(func() {
		cache_Main_functorMTrace = gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer((&Constructor_Data_Functor_Functor{1, gopurs_runtime.Func(func(f_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Func(func(a_1 gopurs_runtime.Value) gopurs_runtime.Value {
				return gopurs_runtime.Apply2(gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Control_Bind_Bind](Get_Main_bindMTrace()).V1), a_1, gopurs_runtime.Func(func(a_prime__2 gopurs_runtime.Value) gopurs_runtime.Value {
					return gopurs_runtime.Apply(gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative](Get_Main_applicativeMTrace()).V1), gopurs_runtime.Apply(f_0, a_prime__2))
				}))
			})
		})}))}
	})
...
func Get_Main_bindMTrace() gopurs_runtime.Value {
	once_Main_bindMTrace.Do(func() {
		cache_Main_bindMTrace = gopurs_runtime.Value{Type: 9, IntVal: 4032919565, UnsafePtr: unsafe.Pointer((&Constructor_Control_Bind_Bind{1, gopurs_runtime.Func(func(_dollar___unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Value{Type: 9, IntVal: 3032403085, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Apply_Apply](Get_Main_applyMTrace()))}
...
func Get_Main_applyMTrace() gopurs_runtime.Value {
	once_Main_applyMTrace.Do(func() {
		cache_Main_applyMTrace = gopurs_runtime.Value{Type: 9, IntVal: 3032403085, UnsafePtr: unsafe.Pointer((&Constructor_Control_Apply_Apply{1, gopurs_runtime.Func(func(_dollar___unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Data_Functor_Functor](Get_Main_functorMTrace()))}
			...
			return gopurs_runtime.Func(func(a_1 gopurs_runtime.Value) gopurs_runtime.Value {
				return gopurs_runtime.Func(func(_ gopurs_runtime.Value) gopurs_runtime.Value {
					...
					_ = x_4_2
					return gopurs_runtime.Apply(gopurs_runtime.Apply(gopurs_runtime.Box(gopurs_runtime.CoerceToStruct[Constructor_Control_Applicative_Applicative](Get_Main_applicativeMTrace()).V1), gopurs_runtime.Apply(x_3_1, x_4_2)), gopurs_runtime.Value{})
				})
			})
		})}))}
	})
...
func Get_Main_applicativeMTrace() gopurs_runtime.Value {
	once_Main_applicativeMTrace.Do(func() {
		cache_Main_applicativeMTrace = gopurs_runtime.Value{Type: 9, IntVal: 1459134221, UnsafePtr: unsafe.Pointer((&Constructor_Control_Applicative_Applicative{1, gopurs_runtime.Func(func(_dollar___unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Value{Type: 9, IntVal: 3032403085, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Apply_Apply](Get_Main_applyMTrace()))}
...
func Get_Main_writerMTrace() gopurs_runtime.Value {
	once_Main_writerMTrace.Do(func() {
		cache_Main_writerMTrace = gopurs_runtime.Value{Type: 9, IntVal: 2544837208, UnsafePtr: unsafe.Pointer((&Constructor_Main_MonadWriter{1, gopurs_runtime.Func(func(_dollar___unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Value{Type: 9, IntVal: 778916621, UnsafePtr: unsafe.Pointer(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Monad](Get_Main_monadMTrace()))}
...
func Get_Main_tell__2495349857() gopurs_runtime.Value {
	once_Main_tell__2495349857.Do(func() {
		cache_Main_tell__2495349857 = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_tell__2495349857(gopurs_runtime.CoerceToStruct[Constructor_Main_MonadWriter](dict_0_box))
		})
	})
...
func Get_Main_test__952106832() gopurs_runtime.Value {
	once_Main_test__952106832.Do(func() {
		cache_Main_test__952106832 = gopurs_runtime.Func(func(dictMonad_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_test__952106832(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Monad](dictMonad_0_box))
		})
	})
	return cache_Main_test__952106832
}

type Constructor_Main_MTrace struct {
	Rc uint32
...
func Call_Main_tell__2495349857(dict_0_loop *Constructor_Main_MonadWriter) gopurs_runtime.Value {
	var dict_0 *Constructor_Main_MonadWriter = dict_0_loop
	_ = dict_0
	return gopurs_runtime.Box(dict_0.V1)
}
