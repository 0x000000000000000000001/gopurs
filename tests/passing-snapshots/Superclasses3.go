...
var cache_Main_MonadWriter_dollar_Dict__3810907048 gopurs_runtime.Value
var once_Main_MonadWriter_dollar_Dict__3810907048 sync.Once

func Get_Main_MonadWriter_dollar_Dict__3810907048() gopurs_runtime.Value {
	once_Main_MonadWriter_dollar_Dict__3810907048.Do(func() {
		cache_Main_MonadWriter_dollar_Dict__3810907048 = gopurs_runtime.Func(func(x_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Value{Type: 9, IntVal: 2544837208, UnsafePtr: unsafe.Pointer(Rebox_Main_1480135733_72788106(Call_Main_MonadWriter_dollar_Dict__3810907048(func() struct {
				Monad0 gopurs_runtime.Value
				tell   gopurs_runtime.Value
			} {
				orig := x_0_box
	...
	return cache_Main_MonadWriter_dollar_Dict__3810907048
}
...
var cache_Main_MTrace__265713757 gopurs_runtime.Value
var once_Main_MTrace__265713757 sync.Once

func Get_Main_MTrace__265713757() gopurs_runtime.Value {
	once_Main_MTrace__265713757.Do(func() {
		cache_Main_MTrace__265713757 = gopurs_runtime.Func(func(__eta_norm_0_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_MTrace__265713757(__eta_norm_0_0_box)
		})
	})
	return cache_Main_MTrace__265713757
}
...
func Get_Main_functorMTrace() gopurs_runtime.Value {
	once_Main_functorMTrace.Do(func() {
		cache_Main_functorMTrace = gopurs_runtime.Value{Type: 9, IntVal: 929368378, UnsafePtr: unsafe.Pointer((&Constructor_Data_Functor_Functor[gopurs_runtime.Value]{1, Call_Control_Monad_liftM1(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Monad[gopurs_runtime.Value]](Get_Main_monadMTrace()))}))}
	})
...
func Get_Main_bindMTrace() gopurs_runtime.Value {
	once_Main_bindMTrace.Do(func() {
		cache_Main_bindMTrace = gopurs_runtime.Value{Type: 9, IntVal: 4032919565, UnsafePtr: unsafe.Pointer((&Constructor_Control_Bind_Bind[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(_dollar___unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
		...
		}), gopurs_runtime.Func2(func(m_0 gopurs_runtime.Value, f_1 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Func(func(_ gopurs_runtime.Value) gopurs_runtime.Value {
				...
				__local_var_3_1 := gopurs_runtime.Apply2(Call_Control_Semigroupoid_compose(gopurs_runtime.CoerceToStruct[Constructor_Control_Semigroupoid_Semigroupoid[gopurs_runtime.Value]](Get_Control_Semigroupoid_semigroupoidFn())), Get_Main_runMTrace(), f_1)
				_ = __local_var_3_1
				__local_var_4_2 := gopurs_runtime.Apply(__local_var_2_0, gopurs_runtime.Value{})
				_ = __local_var_4_2
				return gopurs_runtime.Apply(gopurs_runtime.Apply(__local_var_3_1, __local_var_4_2), gopurs_runtime.Value{})
			})
		})}))}
	})
...
func Get_Main_applyMTrace() gopurs_runtime.Value {
	once_Main_applyMTrace.Do(func() {
		...
		}), Call_Control_Monad_ap(gopurs_runtime.CoerceToStruct[Constructor_Control_Monad_Monad[gopurs_runtime.Value]](Get_Main_monadMTrace()))}))}
	})
...
func Get_Main_writerMTrace() gopurs_runtime.Value {
	once_Main_writerMTrace.Do(func() {
		cache_Main_writerMTrace = gopurs_runtime.Value{Type: 9, IntVal: 2544837208, UnsafePtr: unsafe.Pointer(Rebox_Main_1480135733_72788106((&Constructor_Main_MonadWriter[string, gopurs_runtime.Value]{1, gopurs_runtime.Func(func(_dollar___unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
var cache_Main_test__1489837928 gopurs_runtime.Value
var once_Main_test__1489837928 sync.Once

func Get_Main_test__1489837928() gopurs_runtime.Value {
	once_Main_test__1489837928.Do(func() {
		cache_Main_test__1489837928 = gopurs_runtime.Func(func(__eta_norm_0_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_test__1489837928(__eta_norm_0_0_box.StrVal())
		})
	})
	return cache_Main_test__1489837928
}

var cache_Main_runMTrace__1016380029 gopurs_runtime.Value
var once_Main_runMTrace__1016380029 sync.Once

func Get_Main_runMTrace__1016380029() gopurs_runtime.Value {
	once_Main_runMTrace__1016380029.Do(func() {
		cache_Main_runMTrace__1016380029 = gopurs_runtime.Func(func(v_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_runMTrace__1016380029(v_0_box)
		})
	})
	return cache_Main_runMTrace__1016380029
}
...
func Get_Main_main() gopurs_runtime.Value {
	once_Main_main.Do(func() {
		cache_Main_main = Call_Main_test__1489837928("Done")
	})
...
func Call_Main_MonadWriter_dollar_Dict(x_0_loop struct {
	...
	return gopurs_runtime.CoerceToStruct[Constructor_Main_MonadWriter[gopurs_runtime.Value, gopurs_runtime.Value]](func() gopurs_runtime.Value {
		orig := x_0
		_ = orig
		return gopurs_runtime.RecordDict2("Monad0", "tell", orig.Monad0, orig.tell)
	}())
}

func Call_Main_MonadWriter_dollar_Dict__3810907048(x_0_loop struct {
	Monad0 gopurs_runtime.Value
	tell   gopurs_runtime.Value
}) *Constructor_Main_MonadWriter[string, gopurs_runtime.Value] {
MonadWriter_dollar_Dict__3810907048:
	for {
		if false {
			continue MonadWriter_dollar_Dict__3810907048
		}
		var x_0 struct {
			Monad0 gopurs_runtime.Value
			tell   gopurs_runtime.Value
		...
		_ = x_0
		return gopurs_runtime.CoerceToStruct[Constructor_Main_MonadWriter[string, gopurs_runtime.Value]](func() gopurs_runtime.Value {
			orig := x_0
			_ = orig
			return gopurs_runtime.RecordDict2("Monad0", "tell", orig.Monad0, orig.tell)
		}())
...
func Call_Main_MTrace__265713757(__eta_norm_0_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
MTrace__265713757:
	for {
		if false {
			continue MTrace__265713757
		}
...
func Call_Main_testFunctor(dictMonad_0_loop *Constructor_Control_Monad_Monad[gopurs_runtime.Value]) gopurs_runtime.Value {
	...
	_ = dictMonad_0
	// TAST (Let): Functor0_1_0 shape=App(Other) bindingType=(ADT ["Data","Functor","Functor"] [(TypeVar m$scope4)])
	...
	return gopurs_runtime.Func(func(n_2 gopurs_runtime.Value) gopurs_runtime.Value {
		return gopurs_runtime.Apply2(Functor0_1_0.V0, gopurs_runtime.Func(func(__local_var_3 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_Main_test(dictMonad_0_loop *Constructor_Control_Monad_Monad[gopurs_runtime.Value]) gopurs_runtime.Value {
	var dictMonad_0 *Constructor_Control_Monad_Monad[gopurs_runtime.Value] = dictMonad_0_loop
	_ = dictMonad_0
	// TAST (Let): Bind1_1_0 shape=App(Other) bindingType=(ADT ["Control","Bind","Bind"] [(TypeVar m$scope10)])
	...
	_ = Bind1_1_0
	return gopurs_runtime.Func2(func(dictMonadWriter_2 gopurs_runtime.Value, w_3 gopurs_runtime.Value) gopurs_runtime.Value {
		return gopurs_runtime.Apply2(Call_Control_Bind_bind(Bind1_1_0), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonadWriter_2, "tell"), w_3), gopurs_runtime.Func(func(_dollar___unused_4 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Apply2(Call_Control_Bind_bind(Bind1_1_0), gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictMonadWriter_2, "tell"), w_3), gopurs_runtime.Func(func(_dollar___unused_5 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Call_Main_test__1489837928(__eta_norm_0_0_loop string) gopurs_runtime.Value {
test__1489837928:
	for {
		if false {
			continue test__1489837928
		}
...
func Call_Main_runMTrace__1016380029(v_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
runMTrace__1016380029:
	for {
		if false {
			continue runMTrace__1016380029
		}
		var v_0 gopurs_runtime.Value = v_0_loop
		_ = v_0
		return v_0
...
func Rebox_Main_1480135733_72788106(in *Constructor_Main_MonadWriter[string, gopurs_runtime.Value]) *Constructor_Main_MonadWriter[gopurs_runtime.Value, gopurs_runtime.Value] {
	if in == nil {
		return nil
	}
