...
func Call_Main_ordMu(dictOrd_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
	...
	return gopurs_runtime.Func(func(dictOrd1_2 gopurs_runtime.Value) gopurs_runtime.Value {
		...
		_ = __local_var_3_2
		// TAST (Let): eqMu2_3_1 shape=Let(LitRecord) bindingType=(ADT ["Data","Eq","Eq"] [(ADT ["Main","Product"] [(TypeVar a), (TypeVar b)])])
		eqMu2_3_1 := (&Constructor_Data_Eq_Eq[*Constructor_Main_Product[gopurs_runtime.Value, gopurs_runtime.Value]]{1, gopurs_runtime.Func(func(x_4 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Func(func(y_5 gopurs_runtime.Value) gopurs_runtime.Value {
				return gopurs_runtime.Bool(((gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_1_0, "eq"), (*Constructor_Main_Product[gopurs_runtime.Value, gopurs_runtime.Value])(x_4.UnsafePtr).V0, (*Constructor_Main_Product[gopurs_runtime.Value, gopurs_runtime.Value])(y_5.UnsafePtr).V0).IntVal) != (0)) && ((gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_3_2, "eq"), (*Constructor_Main_Product[gopurs_runtime.Value, gopurs_runtime.Value])(x_4.UnsafePtr).V1, (*Constructor_Main_Product[gopurs_runtime.Value, gopurs_runtime.Value])(y_5.UnsafePtr).V1).IntVal) != (0)))
			})
		})})
		_ = eqMu2_3_1
		return gopurs_runtime.Value{Type: 9, IntVal: 1435789946, UnsafePtr: unsafe.Pointer((&Constructor_Data_Ord_Ord[*Constructor_Main_Product[gopurs_runtime.Value, gopurs_runtime.Value]]{1, gopurs_runtime.Func(func(_dollar___unused_4 gopurs_runtime.Value) gopurs_runtime.Value {
			...
			return gopurs_runtime.Func(func(y_5 gopurs_runtime.Value) gopurs_runtime.Value {
				...
				v_6_3 := uint32(gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictOrd_0, "compare"), (*Constructor_Main_Product[gopurs_runtime.Value, gopurs_runtime.Value])(x_4.UnsafePtr).V0, (*Constructor_Main_Product[gopurs_runtime.Value, gopurs_runtime.Value])(y_5.UnsafePtr).V0).IntVal)
				_ = v_6_3
				var __t4 uint32
				{
					if v_6_3 == 1527465420 {
				...
				{
					__t4 = uint32(gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictOrd1_2, "compare"), (*Constructor_Main_Product[gopurs_runtime.Value, gopurs_runtime.Value])(x_4.UnsafePtr).V1, (*Constructor_Main_Product[gopurs_runtime.Value, gopurs_runtime.Value])(y_5.UnsafePtr).V1).IntVal)
				}
			end_branch_4:
...
func Call_Main_ord1Mu(dictOrd_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
	...
	_ = __local_var_1_1
	// TAST (Let): eq1Mu1_1_0 shape=Let(LitRecord) bindingType=(ADT ["Data","Eq","Eq1"] [(ADT ["Main","Product"] [(TypeVar a)])])
	eq1Mu1_1_0 := (&Constructor_Data_Eq_Eq1[*Constructor_Main_Product[gopurs_runtime.Value, gopurs_runtime.Value]]{1, gopurs_runtime.Func(func(dictEq1_2 gopurs_runtime.Value) gopurs_runtime.Value {
		return gopurs_runtime.Func(func(x_3 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Func(func(y_4 gopurs_runtime.Value) gopurs_runtime.Value {
				return gopurs_runtime.Bool(((gopurs_runtime.Apply2(gopurs_runtime.RecordGet(__local_var_1_1, "eq"), (*Constructor_Main_Product[gopurs_runtime.Value, gopurs_runtime.Value])(x_3.UnsafePtr).V0, (*Constructor_Main_Product[gopurs_runtime.Value, gopurs_runtime.Value])(y_4.UnsafePtr).V0).IntVal) != (0)) && ((gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictEq1_2, "eq"), (*Constructor_Main_Product[gopurs_runtime.Value, gopurs_runtime.Value])(x_3.UnsafePtr).V1, (*Constructor_Main_Product[gopurs_runtime.Value, gopurs_runtime.Value])(y_4.UnsafePtr).V1).IntVal) != (0)))
			})
		})
	})})
	_ = eq1Mu1_1_0
	return gopurs_runtime.Value{Type: 9, IntVal: 1632188299, UnsafePtr: unsafe.Pointer((&Constructor_Data_Ord_Ord1[*Constructor_Main_Product[gopurs_runtime.Value, gopurs_runtime.Value]]{1, gopurs_runtime.Func(func(_dollar___unused_2 gopurs_runtime.Value) gopurs_runtime.Value {
		...
		return gopurs_runtime.Func(func(x_3 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Func(func(y_4 gopurs_runtime.Value) gopurs_runtime.Value {
				// TAST (Let): v_5_2 shape=App(Other) bindingType=(ADT ["Data","Ordering","Ordering"] [])
				v_5_2 := uint32(gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictOrd_0, "compare"), (*Constructor_Main_Product[gopurs_runtime.Value, gopurs_runtime.Value])(x_3.UnsafePtr).V0, (*Constructor_Main_Product[gopurs_runtime.Value, gopurs_runtime.Value])(y_4.UnsafePtr).V0).IntVal)
				_ = v_5_2
				var __t3 uint32
				{
					if v_5_2 == 1527465420 {
				...
				{
					__t3 = uint32(gopurs_runtime.Apply2(gopurs_runtime.RecordGet(dictOrd1_2, "compare"), (*Constructor_Main_Product[gopurs_runtime.Value, gopurs_runtime.Value])(x_3.UnsafePtr).V1, (*Constructor_Main_Product[gopurs_runtime.Value, gopurs_runtime.Value])(y_4.UnsafePtr).V1).IntVal)
				}
			end_branch_3:
