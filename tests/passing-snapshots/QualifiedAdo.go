...
func Call_Main_testIApplicative(dictIxApplicative_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
	...
	return gopurs_runtime.Apply2(Call_IxApplicative_apply(gopurs_runtime.CoerceToStruct[Constructor_IxApplicative_IxApplicative[gopurs_runtime.Value]](dictIxApplicative_0)), gopurs_runtime.Apply2(Call_IxApplicative_go__map(gopurs_runtime.CoerceToStruct[Constructor_IxApplicative_IxFunctor[gopurs_runtime.Value]](gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictIxApplicative_0, "IxFunctor0"), gopurs_runtime.Value{}))), gopurs_runtime.Func2(func(v_1 gopurs_runtime.Value, v1_2 gopurs_runtime.Value) gopurs_runtime.Value {
		return gopurs_runtime.Str((v_1.StrVal()) + (v1_2.StrVal()))
	}), gopurs_runtime.Apply(Call_IxApplicative_pure(gopurs_runtime.CoerceToStruct[Constructor_IxApplicative_IxApplicative[gopurs_runtime.Value]](dictIxApplicative_0)), gopurs_runtime.Str("test"))), gopurs_runtime.Apply(Call_IxApplicative_pure(gopurs_runtime.CoerceToStruct[Constructor_IxApplicative_IxApplicative[gopurs_runtime.Value]](dictIxApplicative_0)), gopurs_runtime.Str("test")))
}

func Call_Main_testApplicative(dictApplicative_0_loop gopurs_runtime.Value) gopurs_runtime.Value {
	var dictApplicative_0 gopurs_runtime.Value = dictApplicative_0_loop
	_ = dictApplicative_0
	return gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApplicative_0, "Apply0"), gopurs_runtime.Value{}), "apply"), gopurs_runtime.Apply2(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(gopurs_runtime.Apply(gopurs_runtime.RecordGet(dictApplicative_0, "Apply0"), gopurs_runtime.Value{}), "Functor0"), gopurs_runtime.Value{}), "map"), gopurs_runtime.Func2(func(v_1 gopurs_runtime.Value, v1_2 gopurs_runtime.Value) gopurs_runtime.Value {
		return gopurs_runtime.Str((v_1.StrVal()) + (v1_2.StrVal()))
