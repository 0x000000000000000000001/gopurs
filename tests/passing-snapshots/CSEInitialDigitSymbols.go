...
var cache_Main_X_2_colon_30IsSymbol gopurs_runtime.Value
var once_Main_X_2_colon_30IsSymbol sync.Once

func Get_Main_X_2_colon_30IsSymbol() gopurs_runtime.Value {
	once_Main_X_2_colon_30IsSymbol.Do(func() {
		cache_Main_X_2_colon_30IsSymbol = gopurs_runtime.Value{Type: 9, IntVal: 2134024384, UnsafePtr: unsafe.Pointer((&Constructor_Data_Symbol_IsSymbol[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(_dollar___unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Str("2:30")
		})}))}
	})
	return cache_Main_X_2_colon_30IsSymbol
}

var cache_Main_X_2IsSymbol gopurs_runtime.Value
var once_Main_X_2IsSymbol sync.Once

func Get_Main_X_2IsSymbol() gopurs_runtime.Value {
	once_Main_X_2IsSymbol.Do(func() {
		cache_Main_X_2IsSymbol = gopurs_runtime.Value{Type: 9, IntVal: 2134024384, UnsafePtr: unsafe.Pointer((&Constructor_Data_Symbol_IsSymbol[gopurs_runtime.Value]{1, gopurs_runtime.Func(func(_dollar___unused_0 gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Str("2")
		})}))}
	})
	return cache_Main_X_2IsSymbol
}
...
func Get_Main_reflectSymbol_prime_() gopurs_runtime.Value {
	once_Main_reflectSymbol_prime_.Do(func() {
		cache_Main_reflectSymbol_prime_ = gopurs_runtime.Func(func(dictIsSymbol_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_reflectSymbol_prime_(gopurs_runtime.CoerceToStruct[Constructor_Data_Symbol_IsSymbol[gopurs_runtime.Value]](dictIsSymbol_0_box))
		})
	})
