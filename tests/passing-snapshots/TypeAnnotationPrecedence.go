...
func Get_Main_appendAndLog() gopurs_runtime.Value {
	once_Main_appendAndLog.Do(func() {
		cache_Main_appendAndLog = gopurs_runtime.Func(func(x_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_appendAndLog(gopurs_runtime.CoerceToStruct[Constructor_Data_Tuple_Tuple](x_0_box))
		})
	})
...
func Call_Main_appendAndLog(x_0_loop *Constructor_Data_Tuple_Tuple) gopurs_runtime.Value {
