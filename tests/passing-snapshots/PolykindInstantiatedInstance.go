...
func Get_Main_fProxy() gopurs_runtime.Value {
	once_Main_fProxy.Do(func() {
		cache_Main_fProxy = gopurs_runtime.Value{Type: 9, IntVal: 1987449688, UnsafePtr: unsafe.Pointer((&Constructor_Main_F{1, gopurs_runtime.Func(func(v_0 gopurs_runtime.Value) gopurs_runtime.Value {
...
func Get_Main_f() gopurs_runtime.Value {
	once_Main_f.Do(func() {
		cache_Main_f = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_f(gopurs_runtime.CoerceToStruct[Constructor_Main_F](dict_0_box))
		})
	})
	return cache_Main_f
}
...
func Get_Main_f__3489368022() gopurs_runtime.Value {
	once_Main_f__3489368022.Do(func() {
		cache_Main_f__3489368022 = gopurs_runtime.Func(func(dict_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_f__3489368022(gopurs_runtime.CoerceToStruct[Constructor_Main_F](dict_0_box))
		})
	})
...
func Call_Main_f(dict_0_loop *Constructor_Main_F) gopurs_runtime.Value {
	var dict_0 *Constructor_Main_F = dict_0_loop
	_ = dict_0
	return gopurs_runtime.Box(dict_0.V0)
}

func Call_Main_f__3489368022(dict_0_loop *Constructor_Main_F) gopurs_runtime.Value {
	var dict_0 *Constructor_Main_F = dict_0_loop
	_ = dict_0
	return gopurs_runtime.Box(dict_0.V0)
}
