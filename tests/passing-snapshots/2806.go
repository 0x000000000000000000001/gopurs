...
func Get_Main_step() gopurs_runtime.Value {
	once_Main_step.Do(func() {
		cache_Main_step = gopurs_runtime.Func(func(v_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return gopurs_runtime.Value{Type: 9, IntVal: 322902991, UnsafePtr: unsafe.Pointer(Call_Main_step(gopurs_runtime.CoerceToStruct[Constructor_Main_Cons[gopurs_runtime.Value]](v_0_box)))}
		})
	})
...
func Get_Main_head() gopurs_runtime.Value {
	once_Main_head.Do(func() {
		cache_Main_head = gopurs_runtime.Func(func(xs_0_box gopurs_runtime.Value) gopurs_runtime.Value {
			return Call_Main_head(gopurs_runtime.CoerceToStruct[Constructor_Main_Cons[gopurs_runtime.Value]](xs_0_box))
		})
	})
...
func Call_Main_head(xs_0_loop *Constructor_Main_Cons[gopurs_runtime.Value]) gopurs_runtime.Value {
	var xs_0 *Constructor_Main_Cons[gopurs_runtime.Value] = xs_0_loop
	_ = xs_0
	return ((xs_0).V1).V0
}
