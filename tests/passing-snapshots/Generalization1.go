	...
	once_Main_main.Do(func() {
		cache_Main_main = func() gopurs_runtime.Value {
			...
			return gopurs_runtime.Func(func(_ gopurs_runtime.Value) gopurs_runtime.Value {
				...
				_dollar___unused_2_2 := gopurs_runtime.Apply(gopurs_runtime.Apply(Get_Effect_Console_log(), gopurs_runtime.Str(gopurs_runtime.Apply(Get_Data_Show_showIntImpl(), gopurs_runtime.Int(gopurs_runtime.Int(3).IntVal)).StrVal())), gopurs_runtime.Value{})
