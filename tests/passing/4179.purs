...
main = do
  err <- assertThrows \_ ->
    ...
    in selfOwn
  assert $ contains (Pattern "interface conversion") err || contains (Pattern "Attempt to read property") err || contains (Pattern "nil pointer") err
  ...
  err2 <- assertThrows \_ ->
    ...
    in f
  assert $ contains (Pattern "interface conversion") err2 || contains (Pattern "Attempt to read property") err2 || contains (Pattern "nil pointer") err2
