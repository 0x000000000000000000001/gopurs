    ...
    return function (v) {
        return {
            ...
            usages: update((function () {
                var $324 = over(Usage)(function (us) {
                    return {
                        access: us.access,
                        arities: us.arities,
                        call: us.call,
                ...
                return function ($325) {
                    return Data_Maybe.Just.create($324($325));
                };
            })())(level)(v.usages)
        };
    };
...
var cased = function (level) {
    return function (v) {
        return {
            ...
            externs: v.externs,
            usages: update((function () {
                var $326 = over(Usage)(function (us) {
                    return {
                        access: us.access,
                        arities: us.arities,
                        call: us.call,
                ...
                return function ($327) {
                    return Data_Maybe.Just.create($326($327));
                };
            })())(level)(v.usages)
        };
    };
...
var analyzeDefault = function (dictHasAnalysis) {
    var $330 = foldMap2(analysisOf(dictHasAnalysis));
    return function ($331) {
        return bump($330($331));
    };
};
var resultOf = function (dictHasAnalysis) {
    var $332 = analysisOf(dictHasAnalysis);
    return function ($333) {
        return (function (v) {
            return v.result;
        })(unwrap($332($333)));
        ...
        return function (externAnalysis) {
            return function (expr) {
                ...
                if (expr instanceof PureScript_Backend_Optimizer_Syntax.LetRec) {
                    return withResult(resultOf1(expr.value2))(complex(NonTrivial.value)(bound(expr.value0)(bump(append4(foldMap3(function ($336) {
                        return analysisOf1(Data_Tuple.snd($336));
                ...
                if (expr instanceof PureScript_Backend_Optimizer_Syntax.Abs) {
                    return withResult(KnownNeutral.value)(complex(KnownSize.value)(capture(CaptureClosure.value)(foldr(function ($337) {
                        return boundArg(Data_Tuple.snd($337));
                    })(analyzeDefault1(expr))(expr.value0))));
                };
                if (expr instanceof PureScript_Backend_Optimizer_Syntax.UncurriedAbs) {
                    return withResult(KnownNeutral.value)(complex(KnownSize.value)(capture(CaptureClosure.value)(foldr1(function ($338) {
                        return boundArg(Data_Tuple.snd($338));
                    })(analyzeDefault1(expr))(expr.value0))));
                };
                ...
                if (expr instanceof PureScript_Backend_Optimizer_Syntax.UncurriedEffectAbs) {
                    return withResult(KnownNeutral.value)(complex(KnownSize.value)(capture(CaptureClosure.value)(foldr1(function ($339) {
                        return boundArg(Data_Tuple.snd($339));
                    })(analyzeDefault1(expr))(expr.value0))));
                };
                ...
                var v = function (v1) {
                    ...
                    if (expr instanceof PureScript_Backend_Optimizer_Syntax.Branch) {
                        ...
                        var result = foldMap1(function ($340) {
                            return resultOf1(PureScript_Backend_Optimizer_Syntax.sndPair($340));
                        })(expr.value0);
                ...
                if (expr instanceof PureScript_Backend_Optimizer_Syntax.App) {
                    var $295 = analysisOf1(expr.value0);
                    var remainingArgs = Data_Array.drop(Data_Array_NonEmpty.length(expr.value1))($295.args);
                    var analysis = (function () {
    ...
    return function (dictHasSyntax) {
        ...
        return function (externAnalysis) {
            return function (expr) {
                ...
                if (expr instanceof PureScript_Backend_Optimizer_Syntax.LetRec) {
                    return withResult(resultOf1(expr.value2))(complex(NonTrivial.value)(bound(expr.value0)(bump(append4(foldMap3(function ($341) {
                        return analysisOf1(Data_Tuple.snd($341));
                    })(expr.value1))(analysisOf1(expr.value2))))));
                };
                if (expr instanceof PureScript_Backend_Optimizer_Syntax.EffectBind) {
