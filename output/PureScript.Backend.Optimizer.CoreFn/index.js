...
var eqProp = function (dictEq) {
    ...
    return {
        eq: function (x) {
            return function (y) {
                return x.value0 === y.value0 && eq10(x.value1)(y.value1);
            };
        }
    };
};
var eqLiteral = function (dictEq) {
    var eq10 = Data_Eq.eq(Data_Eq.eqArray(dictEq));
    var eq11 = Data_Eq.eq(Data_Eq.eqArray(eqProp(dictEq)));
    return {
        eq: function (x) {
            return function (y) {
...
var compare = /* #__PURE__ */ Data_Ord.compare(/* #__PURE__ */ Data_Maybe.ordMaybe(ordModuleName));
var compare1 = /* #__PURE__ */ Data_Ord.compare(ordModuleName);
var ordIdent = Data_Ord.ordString;
var compare2 = /* #__PURE__ */ Data_Ord.compare(ordIdent);
var compare3 = /* #__PURE__ */ Data_Ord.compare(/* #__PURE__ */ Data_Ord.ordArray(ordIdent));
    ...
    traverse: function (dictApplicative) {
        ...
        return function (k) {
            return function (v) {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.CoreFn (line 187, column 16 - line 194, column 40): " + [ v.constructor.name ]);
            };
        };
    },
    sequence: function (dictApplicative) {
...
var exprAnn = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.CoreFn (line 216, column 11 - line 225, column 21): " + [ v.constructor.name ]);
};
...
var eq6 = /* #__PURE__ */ Data_Eq.eq(eqModuleName);
var eqQualified = function (dictEq) {
    var eq10 = Data_Eq.eq(dictEq);
    return {
        eq: function (x) {
            return function (y) {
                return eq5(x.value0)(y.value0) && eq10(x.value1)(y.value1);
            };
        }
    };
};
var ordQualified = function (dictOrd) {
    var compare5 = Data_Ord.compare(dictOrd);
...
var eq7 = /* #__PURE__ */ Data_Eq.eq(eqIdent);
var eq8 = /* #__PURE__ */ Data_Eq.eq(/* #__PURE__ */ Data_Eq.eqArray(eqIdent));
var eqReExport = {
    eq: function (x) {
        return function (y) {
...
var eq9 = /* #__PURE__ */ Data_Eq.eq(eqConstructorType);
var eqMeta = {
    eq: function (x) {
        return function (y) {
...
var compare4 = /* #__PURE__ */ Data_Ord.compare(ordConstructorType);
var ordMeta = {
    compare: function (x) {
        return function (y) {
            if (x instanceof IsConstructor && y instanceof IsConstructor) {
