    ...
    foldMap: function (dictMonoid) {
        ...
        return function (f) {
            return function (v) {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Syntax (line 235, column 15 - line 237, column 28): " + [ v.constructor.name ]);
            };
        };
    }
};
    ...
    traverse: function (dictApplicative) {
        ...
        return function (f) {
            return function (v) {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Syntax (line 241, column 16 - line 243, column 39): " + [ v.constructor.name ]);
            };
        };
    },
    Functor0: function () {
    ...
    foldMap: function (dictMonoid) {
        ...
        return function (f) {
            return function (v) {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Syntax (line 250, column 15 - line 253, column 37): " + [ v.constructor.name ]);
            };
        };
    }
};
    ...
    foldMap: function (dictMonoid) {
        ...
        return function (f) {
            return function (v) {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Syntax (line 133, column 15 - line 160, column 21): " + [ v.constructor.name ]);
            };
        };
    }
};
    ...
    traverse: function (dictApplicative) {
        ...
        return function (f) {
            return function (v) {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Syntax (line 257, column 16 - line 260, column 57): " + [ v.constructor.name ]);
            };
        };
    },
    Functor0: function () {
        ...
        return function (f) {
            return function (v) {
                ...
                if (v instanceof Lit) {
                    ...
                    if (v.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitArray) {
                        return map8(function ($905) {
                            return Lit.create(PureScript_Backend_Optimizer_CoreFn.LitArray.create($905));
                        })(traverse7(f)(v.value0.value0));
                    };
                    if (v.value0 instanceof PureScript_Backend_Optimizer_CoreFn.LitRecord) {
                        return map8(function ($906) {
                            return Lit.create(PureScript_Backend_Optimizer_CoreFn.LitRecord.create($906));
                        })(traverse7(traverse8(f))(v.value0.value0));
                    };
                    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Syntax (line 170, column 7 - line 177, column 71): " + [ v.value0.constructor.name ]);
                };
                if (v instanceof App) {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Syntax (line 164, column 16 - line 217, column 20): " + [ v.constructor.name ]);
            };
        };
    },
    Functor0: function () {
...
var eqPair = function (dictEq) {
    var eq16 = Data_Eq.eq(dictEq);
    return {
        eq: function (x) {
            return function (y) {
                return eq16(x.value0)(y.value0) && eq16(x.value1)(y.value1);
            };
        }
    };
};
var eqLevel = Data_Eq.eqInt;
var eq8 = /* #__PURE__ */ Data_Eq.eq(eqLevel);
var eqTuple2 = /* #__PURE__ */ Data_Tuple.eqTuple(eqMaybe)(eqLevel);
var eq9 = /* #__PURE__ */ Data_Eq.eq(/* #__PURE__ */ Data_Array_NonEmpty_Internal.eqNonEmptyArray(eqTuple2));
var eq10 = /* #__PURE__ */ Data_Eq.eq(/* #__PURE__ */ Data_Eq.eqArray(eqTuple2));
...
var eq11 = /* #__PURE__ */ Data_Eq.eq(eqBackendOperatorOrd);
...
var eq12 = /* #__PURE__ */ Data_Eq.eq(eqBackendOperatorNum);
...
var eq13 = /* #__PURE__ */ Data_Eq.eq(eqBackendOperator2);
...
var eq14 = /* #__PURE__ */ Data_Eq.eq(eqBackendOperator1);
        ...
        eq: function (x) {
            return function (y) {
                if (x instanceof Op1 && y instanceof Op1) {
                    return eq14(x.value0)(y.value0) && eq16(x.value1)(y.value1);
                };
                if (x instanceof Op2 && y instanceof Op2) {
                    return eq13(x.value0)(y.value0) && eq16(x.value1)(y.value1) && eq16(x.value2)(y.value2);
                };
                return false;
            };
        }
...
var eq15 = /* #__PURE__ */ Data_Eq.eq(eqBackendAccessor);
var eqBackendSyntax = function (dictEq) {
    var eq16 = Data_Eq.eq(PureScript_Backend_Optimizer_CoreFn.eqLiteral(dictEq));
    var eq17 = Data_Eq.eq(dictEq);
    var eq18 = Data_Eq.eq(Data_Array_NonEmpty_Internal.eqNonEmptyArray(dictEq));
    var eq19 = Data_Eq.eq(Data_Eq.eqArray(dictEq));
    var eq20 = Data_Eq.eq(Data_Eq.eqArray(PureScript_Backend_Optimizer_CoreFn.eqProp(dictEq)));
    var eq21 = Data_Eq.eq(Data_Eq.eqArray(eqTuple(dictEq)));
    var eq22 = Data_Eq.eq(Data_Array_NonEmpty_Internal.eqNonEmptyArray(eqTuple1(dictEq)));
    var eq23 = Data_Eq.eq(Data_Array_NonEmpty_Internal.eqNonEmptyArray(eqPair(dictEq)));
    var eq24 = Data_Eq.eq(eqBackendOperator(dictEq));
    var eq25 = Data_Eq.eq(eqBackendEffect(dictEq));
    return {
        eq: function (x) {
            return function (y) {
                ...
                if (x instanceof Local && y instanceof Local) {
                    return eq6(x.value0)(y.value0) && eq8(x.value1)(y.value1);
                };
                if (x instanceof Lit && y instanceof Lit) {
                    return eq16(x.value0)(y.value0);
                };
                if (x instanceof App && y instanceof App) {
                    return eq17(x.value0)(y.value0) && eq18(x.value1)(y.value1);
                };
                ...
                if (x instanceof UncurriedApp && y instanceof UncurriedApp) {
                    return eq17(x.value0)(y.value0) && eq19(x.value1)(y.value1);
                };
                ...
                if (x instanceof Accessor && y instanceof Accessor) {
                    return eq17(x.value0)(y.value0) && eq15(x.value1)(y.value1);
                };
                if (x instanceof Update && y instanceof Update) {
                    return eq17(x.value0)(y.value0) && eq20(x.value1)(y.value1);
                };
                if (x instanceof CtorSaturated && y instanceof CtorSaturated) {
                    return eq(x.value0)(y.value0) && eq3(x.value1)(y.value1) && eq4(x.value2)(y.value2) && eq5(x.value3)(y.value3) && eq21(x.value4)(y.value4);
                };
                ...
                if (x instanceof LetRec && y instanceof LetRec) {
                    return eq8(x.value0)(y.value0) && eq22(x.value1)(y.value1) && eq17(x.value2)(y.value2);
                };
                if (x instanceof Let && y instanceof Let) {
                    return eq6(x.value0)(y.value0) && eq8(x.value1)(y.value1) && eq17(x.value2)(y.value2) && eq17(x.value3)(y.value3);
                };
                ...
                if (x instanceof Branch && y instanceof Branch) {
                    return eq23(x.value0)(y.value0) && eq17(x.value1)(y.value1);
                };
