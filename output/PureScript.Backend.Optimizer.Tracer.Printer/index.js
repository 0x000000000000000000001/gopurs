...
var printUnpackOpCase = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Tracer.Printer (line 305, column 21 - line 313, column 30): " + [ v.constructor.name ]);
};
var printRecord = function (sep) {
    ...
    var $233 = foldWithSeparator(Dodo_Common.leadingComma);
    var $234 = map(printProp);
    return function ($235) {
        return Dodo_Common.pursCurlies($233($234($235)));
    };
};
...
var printLet = function (letKeyword) {
    return Data_Tuple.curry((function () {
        var $236 = printLet$prime(letKeyword);
        return function ($237) {
            return $236(pure($237));
        };
    })());
...
var printDistOpCase = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Tracer.Printer (line 316, column 19 - line 328, column 32): " + [ v.constructor.name ]);
};
var printCurriedApp = function (fn) {
    return function (args) {
        return new Data_Tuple.Tuple(PrecApply.value, Dodo.flexGroup(foldWithSeparator1(Dodo.spaceBreak)(Data_Array_NonEmpty.cons(wrapPrec(PrecApply.value)(fn))(map1((function () {
            var $238 = wrapPrec(PrecAccess.value);
            return function ($239) {
                return Dodo.indent($238($239));
            };
        })())(args)))));
    };
};
...
var printBackendRewriteCase = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Tracer.Printer (line 290, column 27 - line 302, column 27): " + [ v.constructor.name ]);
};
var printBackendAccessor = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Tracer.Printer (line 402, column 24 - line 408, column 28): " + [ v.constructor.name ]);
};
var printArray = /* #__PURE__ */ (function () {
    var $240 = foldWithSeparator(Dodo_Common.leadingComma);
    return function ($241) {
        return Dodo_Common.pursSquares($240($241));
    };
})();
var printLiteral = /* #__PURE__ */ (function () {
    var $242 = Data_Tuple.Tuple.create(PrecAtom.value);
    return function ($243) {
        return $242((function (v) {
            ...
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Tracer.Printer (line 411, column 35 - line 425, column 53): " + [ v.constructor.name ]);
        })($243));
    };
})();
var primOp = function (ns) {
    return function (op) {
        ...
        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Tracer.Printer (line 378, column 1 - line 378, column 38): " + [ ns.constructor.name, op.constructor.name ]);
    };
};
var printBackendEffect = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Tracer.Printer (line 334, column 22 - line 340, column 59): " + [ v.constructor.name ]);
};
var printBackendOperator1 = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Tracer.Printer (line 350, column 25 - line 356, column 96): " + [ v.constructor.name ]);
};
var printBackendOperatorNum = function (ns) {
    ...
    return function ($245) {
        return $244((function (v) {
            ...
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Tracer.Printer (line 386, column 44 - line 390, column 22): " + [ v.constructor.name ]);
        })($245));
    };
};
var printBackendOperatorOrd = function (ns) {
    ...
    return function ($247) {
        return $246((function (v) {
            ...
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Tracer.Printer (line 393, column 44 - line 399, column 17): " + [ v.constructor.name ]);
        })($247));
    };
};
var printBackendOperator2 = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Tracer.Printer (line 359, column 25 - line 376, column 58): " + [ v.constructor.name ]);
};
var printBackendOperator = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Tracer.Printer (line 343, column 24 - line 347, column 65): " + [ v.constructor.name ]);
};
var printBackendSyntax = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Tracer.Printer (line 211, column 22 - line 287, column 50): " + [ v.constructor.name ]);
};
