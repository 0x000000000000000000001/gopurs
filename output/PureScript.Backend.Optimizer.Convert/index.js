...
var toCaseRowVars = function (v) {
    return foldMap((function () {
        var $834 = Data_Function.flip(Data_Map_Internal.singleton)(v.column);
        return function ($835) {
            return Data_Map.SemigroupMap($834($835));
        };
    })())(v.pattern.vars);
};
        ...
        var go = function ($copy_columnIdx) {
            return function ($copy_columnsAcc) {
                ...
                function $tco_loop(columnIdx, columnsAcc) {
                    ...
                    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 695, column 7 - line 697, column 63): " + [ nextColumnFields.constructor.name ]);
                };
                while (!$tco_done) {
                ...
                var fromImpl = (function () {
                    if (impl instanceof PureScript_Backend_Optimizer_Semantics.ExternExpr && (impl.value1 instanceof PureScript_Backend_Optimizer_Syntax.App && impl.value1.value0 instanceof PureScript_Backend_Optimizer_Syntax.Var)) {
                        ...
                        if (v instanceof Data_Maybe.Just) {
                            ...
                            var $467 = Data_Map_Internal.isEmpty(newDirs);
                            if ($467) {
                    ...
                    if (backendExpr instanceof PureScript_Backend_Optimizer_Semantics.ExprSyntax && (backendExpr.value1 instanceof PureScript_Backend_Optimizer_Syntax.App && (backendExpr.value1.value0 instanceof PureScript_Backend_Optimizer_Semantics.ExprSyntax && backendExpr.value1.value0.value1 instanceof PureScript_Backend_Optimizer_Syntax.Var))) {
                        ...
                        if (v instanceof Data_Maybe.Just && v.value0 instanceof PureScript_Backend_Optimizer_Semantics.InlineArity) {
                            if (cfn instanceof PureScript_Backend_Optimizer_CoreFn.ExprApp && (cfn.value0.meta instanceof Data_Maybe.Just && cfn.value0.meta.value0 instanceof PureScript_Backend_Optimizer_CoreFn.IsSyntheticApp)) {
                                var $488 = Data_Array_NonEmpty.length(backendExpr.value1.value1);
                                var $489 = $488 >= v.value0.value0;
                                if ($489) {
        ...
        return function (acc) {
            return bind(lookup1(qual)(env.implementations))(function (v) {
                ...
                if (v.value1 instanceof PureScript_Backend_Optimizer_Semantics.ExternDict) {
                    ...
                    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 383, column 9 - line 387, column 19): " + [ acc.constructor.name ]);
                };
                if (v.value1 instanceof PureScript_Backend_Optimizer_Semantics.ExternCtor) {
                    return Data_Maybe.Nothing.value;
                };
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 377, column 5 - line 389, column 16): " + [ v.value1.constructor.name ]);
            });
        };
    };
    return {
        ...
        analyze: function (v) {
            return function (expr) {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 365, column 7 - line 371, column 38): " + [ v1.constructor.name ]);
            };
        },
        effect: false
    };
...
var fromExternImpl = function (v) {
    ...
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 392, column 18 - line 395, column 34): " + [ v.constructor.name ]);
};
var decompose = function (chosenColumn) {
    var mergeResults = function (l) {
        return function (r) {
            ...
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 943, column 22 - line 947, column 123): " + [ l.match.constructor.name, r.match.constructor.name ]);
        };
    };
    var checkMatch = function (p) {
        var v = function (v1) {
            ...
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 909, column 1 - line 909, column 119): " + [ p.constructor.name ]);
        };
        var $543 = eq8(p.column)(chosenColumn.column);
        if ($543) {
            var $544 = eq10(patternPatCase(p))(PatWild.value) || Data_Function.on(eq10)(patternPatCase)(chosenColumn)(p);
            if ($544) {
                return {
                    nonMatchesBefore: [  ],
                    match: new Data_Maybe.Just({
    ...
    return foldMap3(function (row) {
        ...
        if (v instanceof Data_Maybe.Just) {
            var v1 = PureScript_Backend_Optimizer_Utils.foldl1Array(function (l) {
                var $836 = mergeResults(l);
                return function ($837) {
                    return $836(checkMatch($837));
                };
            })(checkMatch)(v.value0);
            if (v1.match instanceof Data_Maybe.Just) {
                return {
                    ...
                    rowsNoMatch: (function () {
                        var $548 = eq10(patternPatCase(v1.match.value0.match))(PatWild.value);
                        if ($548) {
                            return [ row ];
                        };
                        return [  ];
            ...
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 915, column 7 - line 923, column 12): " + [ v1.match.constructor.name ]);
        };
        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 911, column 3 - line 923, column 12): " + [ v.constructor.name ]);
    });
};
    ...
    return function (tailRows) {
                ...
                var keepAllMax = function (acc) {
                    return function (next) {
                        ...
                        if (acc instanceof Data_Maybe.Just) {
                            ...
                            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 799, column 19 - line 802, column 52): " + [ v.constructor.name ]);
                        };
                        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 797, column 7 - line 802, column 52): " + [ acc.constructor.name ]);
                    };
                };
        ...
        if (expandIfPossible instanceof Data_Maybe.Nothing) {
            var matchingPatternGroups = mapFlipped1(row0Patterns)(function (v) {
                var matchingCols = foldMapWithIndex(function (rowIdx) {
                    return function (row) {
                        ...
                        if (v1 instanceof Data_Maybe.Just) {
                            return {
                                tailRowIndices: guard(Data_Function.on(eq10)(patternPatCase)(v.value1)(v1.value0))([ rowIdx + 1 | 0 ]),
                                ...
                                aScore: -Data_Array.length(Data_Array.filter((function () {
                                    var $838 = notEq1(PatWild.value);
                                    return function ($839) {
                                        return $838(patternPatCase($839));
                                    };
                                })())(patternSubterms(v1.value0))) | 0
                            };
                        };
                        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 771, column 15 - line 778, column 20): " + [ v1.constructor.name ]);
                    };
                })(tailRows);
                return {
                    pattern: v.value1,
            ...
            var heuristic = composeKleisli(maximumByAll1(comparing1(function (v) {
                ...
                var $840 = map2(function ($843) {
                    return (function (v) {
                        return v.pattern;
                    })(Data_Array_NonEmpty.head($843));
                });
                var $841 = maximumByAll1(comparing1(function (v) {
                    return v.aScore;
                }));
                return function ($842) {
                    return $840($841($842));
            ...
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 789, column 7 - line 791, column 57): " + [ v.constructor.name ]);
        };
        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 762, column 3 - line 791, column 57): " + [ expandIfPossible.constructor.name ]);
    };
};
    ...
    return function (a) {
        return function (k) {
            return bind1(currentLevel)(function (lvl) {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 955, column 3 - line 959, column 56): " + [ id.constructor.name ]);
            });
        };
    };
};
...
var $lazy_binderToPattern = /* #__PURE__ */ $runtime_lazy("binderToPattern", "PureScript.Backend.Optimizer.Convert", function () {
    ...
    var lookupCtorFields = function (ty) {
        return function (ctor) {
            ...
            return bind1(ask)(function (v) {
                ...
                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 643, column 5 - line 645, column 129): " + [ v1.constructor.name ]);
            });
        };
    };
                ...
                return function (toBinder) {
                    return map3(function (v) {
                        ...
                        return function (nextArg) {
                            ...
                            })($lazy_binderToPattern(628)(toBinder(nextArg)));
                        };
                    }));
                };
            };
    ...
    return function (v) {
        ...
        if (v instanceof PureScript_Backend_Optimizer_CoreFn.BinderNamed) {
            ...
            }))($lazy_binderToPattern(565)(v.value2));
        };
        if (v instanceof PureScript_Backend_Optimizer_CoreFn.BinderLit) {
            ...
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 566, column 22 - line 586, column 18): " + [ v.value1.constructor.name ]);
        };
        if (v instanceof PureScript_Backend_Optimizer_CoreFn.BinderConstructor) {
            ...
            if (v.value0.meta instanceof Data_Maybe.Just && v.value0.meta.value0 instanceof PureScript_Backend_Optimizer_CoreFn.IsNewtype) {
                if (v.value3.length === 1) {
                    return $lazy_binderToPattern(592)(v["value3"][0]);
                };
                return v1(true);
            };
            return v1(true);
        };
        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 560, column 19 - line 614, column 55): " + [ v.constructor.name ]);
    };
});
var binderToPattern = /* #__PURE__ */ $lazy_binderToPattern(559);
var toBackendBinding = function (v) {
    return map3(Data_Tuple.Tuple.create(v.value1))($lazy_toBackendExpr(1011)(v.value2));
};
var buildCaseTreeFromRows = function (denormalizedRows) {
    ...
    if (v instanceof Data_Maybe.Just) {
        ...
        var row0NonPatWildPatterns = Data_Array_NonEmpty.fromArray(foldlWithIndex(function (idx) {
            return function (acc) {
                return function (p) {
                    var $640 = notEq1(patternPatCase(p))(PatWild.value);
                    if ($640) {
        ...
        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 681, column 5 - line 685, column 95): " + [ row0NonPatWildPatterns.constructor.name ]);
    };
    throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 670, column 42 - line 685, column 95): " + [ v.constructor.name ]);
};
var buildCasePattern = function (chosenColumn) {
    return function (rows) {
        ...
        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 811, column 38 - line 831, column 37): " + [ v.constructor.name ]);
    };
};
var buildCaseLeaf = function (row0) {
    return function (tailRows) {
        ...
        if (row0.guardFn instanceof GuardedFn) {
            return foldr(function (v) {
                ...
                return bind1($$for(row0.guardFn.value0)(function (v) {
                    return apply(map3(PureScript_Backend_Optimizer_Syntax.Pair.create)($lazy_toBackendExpr(753)(v.value0)))(callFn(v.value1)(args));
                }))(function (pairs) {
        ...
        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 736, column 3 - line 758, column 11): " + [ row0.guardFn.constructor.name ]);
    };
};
var $lazy_toBackendExpr = /* #__PURE__ */ $runtime_lazy("toBackendExpr", "PureScript.Backend.Optimizer.Convert", function () {
                            ...
                            return bind1(zipWithA(function (ident) {
                                ...
                                if (v.value1 instanceof PureScript_Backend_Optimizer_CoreFn.Unconditional) {
                                    return makeLet(Data_Maybe.Nothing.value)(makeUncurriedAbs(args)(function (v1) {
                                        return $lazy_toBackendExpr(487)(v.value1.value0);
                                    }))(function (tmp) {
                                ...
                                if (v.value1 instanceof PureScript_Backend_Optimizer_CoreFn.Guarded) {
                                    return foldr(function (v1) {
                                        return function (cb) {
                                            return function (xs) {
                                                return makeLet(Data_Maybe.Nothing.value)(makeUncurriedAbs(args)(function (v2) {
                                                    return $lazy_toBackendExpr(492)(v1.value1);
                                                }))(function (tmp) {
                                        ...
                                        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 496, column 21 - line 499, column 84): " + [ v1.constructor.name ]);
                                    })(v.value1.value0)([  ]);
                                };
                                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 485, column 11 - line 502, column 19): " + [ v.value1.constructor.name ]);
                            });
                        };
                    };
                })(useCaseRowsCb)(alts)([  ]);
    ...
    return function (v) {
            ...
            return bind1(ask)(function (v1) {
                var v2 = function (v3) {
                    ...
                    if (v.value1.value0 instanceof Data_Maybe.Just) {
                        var $708 = eq9(v.value1.value0.value0)(v1.currentModule);
                        if ($708) {
                            var $709 = lookup4(v.value1.value1)(v1.toLevel);
                            if ($709 instanceof Data_Maybe.Just) {
                                return buildM(new PureScript_Backend_Optimizer_Syntax.Local(new Data_Maybe.Just(v.value1.value1), $709.value0));
                            };
                            return v4(true);
                        };
                        return v4(true);
                ...
                if (v.value1.value0 instanceof Data_Maybe.Nothing) {
                    var $715 = lookup4(v.value1.value1)(v1.toLevel);
                    if ($715 instanceof Data_Maybe.Just) {
                        return buildM(new PureScript_Backend_Optimizer_Syntax.Local(new Data_Maybe.Just(v.value1.value1), $715.value0));
                    };
                    return v2(true);
                };
                return v2(true);
        ...
        if (v instanceof PureScript_Backend_Optimizer_CoreFn.ExprLit) {
            return bindFlipped(function ($844) {
                return buildM(PureScript_Backend_Optimizer_Syntax.Lit.create($844));
            })(traverse($lazy_toBackendExpr(427))(v.value1));
        };
        ...
        if (v instanceof PureScript_Backend_Optimizer_CoreFn.ExprAccessor) {
            return bindFlipped((function () {
                var $845 = Data_Function.flip(PureScript_Backend_Optimizer_Syntax.Accessor.create)(new PureScript_Backend_Optimizer_Syntax.GetProp(v.value2));
                return function ($846) {
                    return buildM($845($846));
                };
            })())($lazy_toBackendExpr(436)(v.value1));
        };
        if (v instanceof PureScript_Backend_Optimizer_CoreFn.ExprUpdate) {
            ...
            })($lazy_toBackendExpr(439)(v.value1)))(traverse1(traverse2($lazy_toBackendExpr(440)))(v.value2)));
        };
        if (v instanceof PureScript_Backend_Optimizer_CoreFn.ExprAbs) {
            return bind1(currentLevel)(function (lvl) {
                return make(new PureScript_Backend_Optimizer_Syntax.Abs(Data_Array_NonEmpty.singleton(new Data_Tuple.Tuple(new Data_Maybe.Just(v.value1), lvl)), intro1([ v.value1 ])(lvl)($lazy_toBackendExpr(443)(v.value2))));
            });
        };
        var v1 = function (v2) {
            if (v instanceof PureScript_Backend_Optimizer_CoreFn.ExprApp && Data_Boolean.otherwise) {
                return make(new PureScript_Backend_Optimizer_Syntax.App($lazy_toBackendExpr(448)(v.value1), Data_Array_NonEmpty.singleton($lazy_toBackendExpr(448)(v.value2))));
            };
            if (v instanceof PureScript_Backend_Optimizer_CoreFn.ExprLet) {
                var go = function (bind$prime) {
                    return function (next) {
                        if (bind$prime instanceof PureScript_Backend_Optimizer_CoreFn.NonRec) {
                            return makeLet(new Data_Maybe.Just(bind$prime.value0.value1))($lazy_toBackendExpr(454)(bind$prime.value0.value2))(function (v3) {
                                return next;
                            });
                        };
                        var v3 = function (v4) {
                            ...
                            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 411, column 1 - line 411, column 50): " + [ bind$prime.constructor.name ]);
                        };
                        if (bind$prime instanceof PureScript_Backend_Optimizer_CoreFn.Rec) {
                            var $755 = Data_Array_NonEmpty.fromArray(bind$prime.value0);
                            if ($755 instanceof Data_Maybe.Just) {
                                return bind1(currentLevel)(function (lvl) {
                                    ...
                                    })(intro2(idents)(lvl)(traverse3(toBackendBinding)($755.value0))))(intro2(idents)(lvl)(next)));
                                });
                            };
                            return v3(true);
                        };
                ...
                return foldr(go)($lazy_toBackendExpr(450)(v.value2))(v.value1);
            };
            if (v instanceof PureScript_Backend_Optimizer_CoreFn.ExprCase) {
                return foldr(function (expr) {
                    return function (next) {
                        return function (idents) {
                            return makeLet(Data_Maybe.Nothing.value)($lazy_toBackendExpr(466)(expr))(function (tmp) {
            ...
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 411, column 1 - line 411, column 50): " + [ v.constructor.name ]);
        };
        if (v instanceof PureScript_Backend_Optimizer_CoreFn.ExprApp) {
            if (v.value1 instanceof PureScript_Backend_Optimizer_CoreFn.ExprVar && (v.value1.value0.meta instanceof Data_Maybe.Just && v.value1.value0.meta.value0 instanceof PureScript_Backend_Optimizer_CoreFn.IsNewtype)) {
                return $lazy_toBackendExpr(446)(v.value2);
            };
            return v1(true);
        };
        return v1(true);
...
var toBackendExpr = /* #__PURE__ */ $lazy_toBackendExpr(411);
var toTopLevelBackendBinding = function (group) {
    return function (env) {
        return function (v) {
            ...
            var v2 = toExternImpl(env)(group)(v1.value1);
            return {
                accum: {
                    analyzeCustom: env.analyzeCustom,
                    currentLevel: env.currentLevel,
                    ...
                    optimizationSteps: Data_Maybe.maybe(env.optimizationSteps)((function () {
                        var $847 = Data_Array.snoc(env.optimizationSteps);
                        var $848 = Data_Tuple.Tuple.create(qualifiedIdent);
                        return function ($849) {
                            return $847($848($849));
                        };
                    ...
                    directives: (function () {
                        ...
                        if (v4 instanceof Data_Maybe.Just) {
                            return alter(function (v5) {
                                ...
                                throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 261, column 17 - line 265, column 30): " + [ v5.constructor.name ]);
                        ...
                        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 258, column 11 - line 269, column 29): " + [ v4.constructor.name ]);
                    })()
                },
...
var toBackendTopLevelBindingGroup = function (env) {
    ...
    return function (v) {
        ...
        throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 227, column 37 - line 234, column 52): " + [ v.constructor.name ]);
    };
};
var toBackendTopLevelBindingGroups = function (binds) {
    return function (env) {
        ...
        return {
            ...
            })(Data_Array.groupBy(Data_Function.on(conj)(function ($850) {
                return !(function (v1) {
                    return v1.recursive;
                })($850);
            }))(result.value))
...
var toBackendModule = function (v) {
    return function (env) {
        ...
        var ctors = bind2(bind2(v.decls)(function (v1) {
            ...
            throw new Error("Failed pattern match at PureScript.Backend.Optimizer.Convert (line 127, column 42 - line 129, column 39): " + [ v1.constructor.name ]);
        }))(function (v1) {
            if (v1.value2 instanceof PureScript_Backend_Optimizer_CoreFn.ExprConstructor) {
                return pure2(new Data_Tuple.Tuple(v1.value2.value1, new Data_Tuple.Tuple(v1.value2.value2, v1.value2.value3)));
            };
            return [  ];
        });
        var dataTypes = fromFoldable3(map(function (group) {
            ...
            var sizes = map4(function ($851) {
                return Data_Array.length(Data_Tuple.snd(Data_Tuple.snd($851)));
            })(group);
        ...
        var usedBindings = mapAccumR(function (deps) {
            return function (group) {
                var v1 = (function () {
                    if (group.recursive) {
                        var $824 = Data_Array.any(isBindingUsed(deps))(group.bindings);
                        if ($824) {
                            return {
                                accum: append3(foldMap5(function ($852) {
                                    return Data_Tuple.fst(Data_Tuple.snd($852));
                                })(group.bindings))(deps),
                                value: map((function () {
                                    var $853 = map5(Data_Tuple.snd);
                                    return function ($854) {
                                        return Data_Maybe.Just.create($853($854));
                                    };
                                })())(group.bindings)
                            };
                        };
                    ...
                    return mapAccumR(function (deps$prime) {
                        return function (v2) {
                            var $826 = isBindingUsed(deps$prime)(v2);
                            if ($826) {
                                return {
        ...
        return new Data_Tuple.Tuple(moduleBindings.accum.optimizationSteps, {
            ...
            dataTypes: filter((function () {
                var $855 = Data_Array.any(isBindingUsed(usedBindings.accum));
                return function ($856) {
                    return $855(toUnfoldable1((function (v1) {
