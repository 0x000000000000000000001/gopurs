...
- [ ] **3.4 — Extraire la préparation des métadonnées.** Les préparations des types globaux, des constructeurs, des classes et des représentations ADT sont extraites (3.4.1–3.4.4). Reste à isoler la préparation de la monomorphisation.
