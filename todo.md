...
- [ ] **3.4 — Extraire la préparation des métadonnées.** Les types globaux sont extraits (3.4.1). Restent les tables de constructeurs, les tables de classes et la préparation de la monomorphisation, à déplacer séparément.
