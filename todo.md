...
Les structures partagées ont des alias, `translate` reçoit les métadonnées et le module, et les options du traducteur sont nommées. La durée de vie de `globalReboxPairs` reste à clarifier.
