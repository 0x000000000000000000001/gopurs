...
- [ ] **3.4 — Extraire la préparation des métadonnées.** Les types globaux et les tables de constructeurs sont extraits (3.4.1–3.4.2). Restent les tables de classes, les métadonnées de représentation des ADT et la préparation de la monomorphisation, à déplacer séparément.
