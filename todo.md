...
Constat actualisé le 9 septembre 2026 : `translateExprWithExpectedType` rassemble encore environ 1 830 lignes. Les expressions primitives et les records ordinaires sont désormais construits par `PrimitiveExprs` et `RecordExprs`, sans dépendance vers `CodeGen` ; la traversée et l'assemblage des statements restent centraux.
