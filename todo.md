...
Les structures partagées ont maintenant des alias et `translate` reçoit les métadonnées et le module. Les options du traducteur restent positionnelles ; la durée de vie de `globalReboxPairs` reste à clarifier.
