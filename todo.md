...
- [ ] **3.4 — Extraire la préparation des métadonnées.** Les types globaux et les métadonnées de constructeurs et de classes sont extraits (3.4.1–3.4.3). Restent les métadonnées de représentation des ADT et la préparation de la monomorphisation, à déplacer séparément.
